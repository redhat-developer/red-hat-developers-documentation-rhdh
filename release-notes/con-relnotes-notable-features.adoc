...
You can use the {product} Operator to install {product-short} on your OpenShift Container Platform cluster. For more information, see the link:{LinkAdminGuide}#proc-install-rhdh-operator_{context}[Installing {product} using the Operator] section in the _Administration guide_.
...
For more information, see the link:{LinkAdminGuide}#con-rbac-overview_{context}[Role-Based Access Control in {product}] section in the _Administration guide_.
...
For more information, see the link:{LinkAdminGuide}#con-rhdh-integration-aws_{context}[{product} integration with Amazon Web Services] section in the _Administration guide_.
