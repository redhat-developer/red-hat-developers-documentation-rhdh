...
// Operator method
include::assemblies/install_installing-rhdh-on-ocp/assembly-install-product-on-ocp-short-with-the-operator.adoc[leveloffset=+1]

// Helm chart method
include::assemblies/install_installing-rhdh-on-ocp/assembly-install-product-on-ocp-short-with-the-helm-chart.adoc[leveloffset=+1]
