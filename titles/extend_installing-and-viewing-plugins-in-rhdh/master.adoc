...
include::assemblies/extend_installing-and-viewing-plugins-in-rhdh/assembly-extend-and-customize-the-rhdh-user-interface-with-the-new-front-end-system.adoc[leveloffset=+1]
