...
include::assemblies/extend_installing-and-viewing-plugins-in-rhdh/assembly-customize-the-rhdh-interface-with-the-new-front-end-system.adoc[leveloffset=+1]
