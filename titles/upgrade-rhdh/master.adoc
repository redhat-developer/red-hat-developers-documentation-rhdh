...
:abstract: You can upgrade a {product} ({product-very-short}) instance to a later version from the {ocp-short} web console using either the Operator or the Helm chart.
