...
include::modules/shared/con-using-ansible-plug-ins-for-red-hat-developer-hub.adoc[leveloffset=+1]
...
include::assemblies/extend_shared/assembly-use-the-topology-plugin.adoc[leveloffset=+1]
