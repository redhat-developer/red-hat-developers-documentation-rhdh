...
:abstract: As a {product} ({product-very-short}) Operations or Project Manager, you can monitor performance and gather insights using {product}'s monitoring and logging tools.
