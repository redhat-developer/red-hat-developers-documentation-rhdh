...
include::modules/discover_about-rhdh/con-achieve-high-availability-with-database-and-cache-layers.adoc[leveloffset=+1]
...
include::modules/discover_about-rhdh/ref-rhdh-sizing.adoc[leveloffset=+1]
include::modules/discover_about-rhdh/ref-customer-support-info.adoc[leveloffset=+1]
