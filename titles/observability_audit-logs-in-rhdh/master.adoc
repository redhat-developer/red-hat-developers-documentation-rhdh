...
include::modules/observability_audit-logs-in-rhdh/proc-configure-audit-logs.adoc[leveloffset=+1]

include::modules/observability_audit-logs-in-rhdh/proc-forward-product-audit-logs-to-splunk.adoc[leveloffset=+1]

include::modules/observability_audit-logs-in-rhdh/proc-view-audit-logs-in-product-short.adoc[leveloffset=+1]
