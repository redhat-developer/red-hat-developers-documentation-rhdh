...
include::modules/shared/con-about-developer-lightspeed.adoc[leveloffset=+1]

include::modules/shared/con-supported-architecture.adoc[leveloffset=+1]

include::modules/shared/con-about-lightspeed-stack-and-llama-stack.adoc[leveloffset=+2]

include::modules/shared/con-rag-embeddings.adoc[leveloffset=+1]

include::modules/shared/proc-install-and-configure-lightspeed.adoc[leveloffset=+1]

include::assemblies/shared/assembly-customizing-developer-lightspeed.adoc[leveloffset=+1]
