...
include::modules/admin/ref-rbac-permission-policies.adoc[leveloffset=+3]
...
// Content for vulnerabilities, SBOM, and view Output
include::modules/rhdh-plugins-reference/setting-up-openshift-pipelines-to-view-software-supply-chain-security-elements.adoc[leveloffset=+1]