...
// Operator procedure
include::modules/install-rhdh-osd-gcp/proc-install-rhdh-osd-gcp-operator.adoc[leveloffset=+1]

// Helm procedure
include::modules/install-rhdh-osd-gcp/proc-install-rhdh-osd-gcp-helm.adoc[leveloffset=+1]
