...
include::modules/observability_evaluate-project-health-using-scorecards/proc-configure-an-aggregation-card-with-a-weighted-status-score-tracking-type.adoc[leveloffset=+1]

include::modules/observability_evaluate-project-health-using-scorecards/proc-configure-an-aggregation-card-with-a-scalar-tracking-type.adoc[leveloffset=+1]
