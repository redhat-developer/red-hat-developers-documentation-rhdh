...
Use this reference to look up the permission strings required when defining RBAC policies for catalog, scaffolder, RBAC, Kubernetes, Extensions, Orchestrator, and plugin resources.
