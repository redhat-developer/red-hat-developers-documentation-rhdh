...
[role="_abstract"]
Install {product} on {eks-short} by using the {product} Operator with the Operator Lifecycle Manager (OLM) framework for over-the-air updates and catalogs.
...
On {eks-short}, the most notable differences over an OpenShift-based installation are:
