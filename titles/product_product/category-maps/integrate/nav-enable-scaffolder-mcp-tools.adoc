...
include::modules/integrate_interacting-with-model-context-protocol-tools-for-rhdh/con-software-template-validation-with-scaffolder-dry-run-tools.adoc[leveloffset=+1,navtitle="Automate software resource creation"]
...
include::modules/integrate_interacting-with-model-context-protocol-tools-for-rhdh/ref-list-scaffolder-actions.adoc[leveloffset=+1,navtitle="Automate Software Templates"]
