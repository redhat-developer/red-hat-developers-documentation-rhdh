...
// RHIDP-4165: This assembly is not included in any title as the multi-chapter format has been adopted in all installation titles.
...
// Operator method
include::assembly-install-rhdh-ocp-operator.adoc[leveloffset=+1]

// Helm chart method
include::assembly-install-rhdh-ocp-helm.adoc[leveloffset=+1]
