...
include::modules/techdocs/proc-install-and-configure-an-external-techdocs-add-on-using-the-operator.adoc[leveloffset=+1]

include::modules/techdocs/proc-install-and-configure-an-external-techdocs-add-on-using-the-helm-chart.adoc[leveloffset=+1]

include::modules/techdocs/proc-install-and-configure-a-third-party-techdocs-add-on.adoc[leveloffset=+1]
