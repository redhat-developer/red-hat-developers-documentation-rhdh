...
include::modules/customizing-templates/proc-version-a-software-template.adoc[leveloffset=+1]
include::modules/customizing-templates/proc-enable-software-template-version-update-notifications.adoc[leveloffset=+1]
