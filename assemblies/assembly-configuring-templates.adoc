...
include::modules/customizing-templates/proc-enabling-automated-software-template-upgrades.adoc[leveloffset=+1]
include::modules/customizing-templates/proc-upgrading-component-from-software-template-version.adoc[leveloffset=+1]
