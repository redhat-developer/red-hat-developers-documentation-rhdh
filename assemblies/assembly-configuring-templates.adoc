...
include::modules/customizing-templates/con-about-software-templates.adoc[leveloffset=+1]
...
include::modules/customizing-templates/proc-viewing-the-results-of-software-component-creation.adoc[leveloffset=+1]
