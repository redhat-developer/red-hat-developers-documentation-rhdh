...
[id="about-orchestrator-in-red-hat-developer-hub_{context}"]
:context: about-orchestrator-in-red-hat-developer-hub
...
include::modules/orchestrator/con-understand-orchestrator-architecture.adoc[leveloffset=+1]

// getting started
include::modules/orchestrator/con-getting-started-with-orchestrator.adoc[leveloffset=+1]

// provisioning plugin dependencies
include::modules/orchestrator/con-orchestrator-plugin-dependencies-for-operator-installation.adoc[leveloffset=+1]