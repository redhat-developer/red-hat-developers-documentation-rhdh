...
[role="_abstract"]
When using third-party AI integrations, you can store your personal access tokens securely and manage credentials in {product} so that the AI acts on your behalf without over-privileged permissions.
