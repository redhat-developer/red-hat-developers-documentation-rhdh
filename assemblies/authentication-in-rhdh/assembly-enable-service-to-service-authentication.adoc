...
include::../modules/authentication-in-rhdh//proc-enable-service-to-service-authentication-by-using-a-static-token.adoc[leveloffset=+1]


include::../modules/authentication-in-rhdh//proc-enable-service-to-service-authentication-by-using-jwks-tokens.adoc[leveloffset=+1]


include::../modules/authentication-in-rhdh//proc-set-access-restrictions-to-external-service-tokens.adoc[leveloffset=+1]
