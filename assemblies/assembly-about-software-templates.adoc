...
include::modules/customizing-templates/proc-version-a-software-template-in-product.adoc[leveloffset=+1]
include::modules/customizing-templates/proc-enable-software-template-version-update-notifications-in-product.adoc[leveloffset=+1]
include::assembly-tracking-component-origin-and-software-template-version.adoc[leveloffset=+1]
include::assembly-automated-software-template-lifecycle-management.adoc[leveloffset=+1]
