...
include::modules/customizing/proc-version-a-software-template-in-product.adoc[leveloffset=+1]
include::modules/customizing/proc-enable-software-template-version-update-notifications-in-product.adoc[leveloffset=+1]
