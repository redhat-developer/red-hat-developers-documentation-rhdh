...
include::modules/observe/proc-configure-audit-logs.adoc[leveloffset=+1]

include::modules/observe/proc-forward-product-audit-logs-to-splunk.adoc[leveloffset=+1]

include::modules/observe/proc-view-audit-logs-in-product-short.adoc[leveloffset=+1]
