...
To optimize your workspace for productivity and maintain accurate asset tracking, customize the interface settings and review your user profile in {product} ({product-very-short}). Personalizing your environment aligns the portal with your system preferences, while reviewing your profile confirms that you are correctly associated with your team's services in the Software Catalog.
