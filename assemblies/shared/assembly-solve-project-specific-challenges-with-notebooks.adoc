...
+
image::integrate_interacting-with-developer-lightspeed-for-rhdh/lightspeed-notebook-fullscreen-page.png["Intelligent assistant Notebook full-screen page"]
