...
Notebooks are available in overlay, docked, and fullscreen display modes. In overlay and docked modes, the resource panel is togglable, allowing you to work with notebooks on smaller screens without switching to fullscreen.
