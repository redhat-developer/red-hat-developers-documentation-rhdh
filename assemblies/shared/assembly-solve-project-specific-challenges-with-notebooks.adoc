...
+
image::integrate_interacting-with-the-intelligent-assistant-for-rhdh/lightspeed-notebook-fullscreen-page.png["Intelligent assistant Notebook full-screen page"]
