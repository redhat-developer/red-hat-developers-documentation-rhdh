...
Notebooks are available in overlay, docked, and fullscreen display modes. In overlay and docked modes, you can toggle the resource panel, allowing you to work with notebooks on smaller screens without switching to fullscreen.
...
+
image::integrate_interacting-with-developer-lightspeed-for-rhdh/lightspeed-notebook-fullscreen-page.png["{ls-short} Notebook fullscreen page"]
