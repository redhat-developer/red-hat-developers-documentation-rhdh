...
+
image::integrate_shared/lightspeed-notebook-fullscreen-page.png["Intelligent assistant Notebook full-screen page"]

include::{docdir}/artifacts/snip-developer-preview.adoc[]

include::../modules/shared/proc-enable-secure-ai-research-with-intelligent-assistant-notebooks.adoc[leveloffset=+1]
include::../modules/shared/proc-enable-data-persistence-for-intelligent-assistant-notebooks.adoc[leveloffset=+1]
