...
include::../modules/shared/proc-configuring-the-RBAC-backend-plugin.adoc[leveloffset=+1]

include::../modules/shared/proc-setting-up-the-guest-authentication-provider.adoc[leveloffset=+1]
