...
[id="build-a-private-knowledge-base-with-developer-lightspeed-notebooks_{context}"]
= Build a private knowledge base with {ls-short} Notebooks

:context: build-a-private-knowledge-base-with-developer-lightspeed-notebooks
