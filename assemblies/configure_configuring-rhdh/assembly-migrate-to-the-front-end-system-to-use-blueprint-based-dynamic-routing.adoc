...
// Optimize migrated plugins for fast page loads
include::../modules/shared/con-optimize-custom-plugins-for-fast-load-in-the-new-frontend-system.adoc[leveloffset=+1]

// Plugin optimization patterns reference
include::../modules/shared/ref-new-frontend-system-plugin-optimization-patterns.adoc[leveloffset=+1]
...
// Troubleshoot plugin load failures after upgrade
include::../modules/shared/ref-troubleshoot-plugin-load-failures-in-the-new-frontend-system.adoc[leveloffset=+1]
