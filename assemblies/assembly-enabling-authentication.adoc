...
[id="assembly-enabling-authentication"]
= Enabling authentication in {product}
:context: assembly-enabling-authentication
...
include::modules/proc-adding-azure-as-an-authentication-provider.adoc[leveloffset=+1]
