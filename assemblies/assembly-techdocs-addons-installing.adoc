...
* {configuring-dynamic-plugins-book-url}[{configuring-dynamic-plugins-book-title}]
* {installing-and-viewing-plugins-book-url}[{installing-and-viewing-plugins-book-title}]
