...
include::modules/configuring-a-floating-action-button/proc-configure-a-floating-action-button-as-a-dynamic-plugin.adoc[leveloffset=+1]

// Localization
include::modules/configuring-a-floating-action-button/con-floating-action-button-localization-support.adoc[leveloffset=+1]
// END Localization
