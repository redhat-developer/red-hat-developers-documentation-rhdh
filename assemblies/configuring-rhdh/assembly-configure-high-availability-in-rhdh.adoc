...
include::../modules/configuring-rhdh/proc-configure-high-availability-in-a-rhdh-operator-deployment.adoc[leveloffset=+1]

include::../modules/configuring-rhdh/proc-configure-high-availability-in-a-rhdh-helm-chart-deployment.adoc[leveloffset=+1]
