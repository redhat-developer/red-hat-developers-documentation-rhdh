...
* Search input field
* *Create* button provides quick access to a variety of templates, enabling users to efficiently set up services, backend and frontend plugins within {product-short}.
