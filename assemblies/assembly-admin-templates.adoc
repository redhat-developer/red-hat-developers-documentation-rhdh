...
A template is a form composed of different UI fields that is defined in a YAML file. Templates include _actions_, which are defined as steps that are executed in sequential order and can be executed conditionally.
...
include::modules/admin/con-actions.adoc[leveloffset=+1]
include::modules/admin/proc-creating-custom-actions.adoc[leveloffset=+2]
