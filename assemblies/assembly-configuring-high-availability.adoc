...
include::modules/configuring-high-availability/proc-configure-high-availability-in-rhdh-operator-deployment.adoc[leveloffset=+1]

include::modules/configuring-high-availability/proc-configure-high-availability-in-rhdh-helm-chart-deployment.adoc[leveloffset=+1]
