...
include::../modules/customizing-rhdh/proc-customize-your-rhdh-global-header.adoc[leveloffset=+1]


include::../modules/customizing-rhdh/ref-mount-points-for-dynamic-plugin-integration.adoc[leveloffset=+1]

include::../modules/customizing-rhdh/proc-configure-the-logo-in-the-global-header.adoc[leveloffset=+1]

include::../modules/customizing-rhdh/proc-enable-logo-in-the-sidebar.adoc[leveloffset=+1]

include::../modules/customizing-rhdh/proc-display-the-preferred-username-in-the-profile-dropdown.adoc[leveloffset=+1]

include::../modules/customizing-rhdh/con-quicklinks-and-starred-items-in-the-global-header.adoc[leveloffset=+1]

include::../modules/customizing-rhdh/proc-enable-quicklinks-and-starred-items-after-an-upgrade.adoc[leveloffset=+1]
