...
include::../modules/customizing-rhdh/proc-version-a-software-template-in-rhdh.adoc[leveloffset=+1]
include::../modules/customizing-rhdh/proc-enable-software-template-version-update-notifications-in-rhdh.adoc[leveloffset=+1]
