...
include::modules/configuring-a-proxy/con-no-proxy-exclusion-rules.adoc[leveloffset=+1]


include::modules/configuring-a-proxy/proc-configure-proxy-in-operator-deployment.adoc[leveloffset=+1]


include::modules/configuring-a-proxy/proc-configure-proxy-in-helm-deployment.adoc[leveloffset=+1]
