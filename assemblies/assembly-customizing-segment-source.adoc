...
[id="assembly-customizing-segment-source"]
...
include::modules/analytics/proc-customizing-telemetry-segment-using-operator.adoc[leveloffset=+1]

include::modules/analytics/proc-customizing-segment-source-using-helm.adoc[leveloffset=+1]
