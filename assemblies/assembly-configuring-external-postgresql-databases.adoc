...
By default, the {product} or Helm Chart creates a local PostgreSQL database, but this is not recommended for production use. For production use, disable the local database creation and connect {product-short} to an external PostgreSQL instance.
====
