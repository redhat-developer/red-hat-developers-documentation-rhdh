...
[NOTE]
====
In {product} 2.1, the floating action button plugin is removed. Quick-access functionality is now provided by the global header components. If you previously configured the floating action button plugin, update your configuration to use the global header instead.
====
