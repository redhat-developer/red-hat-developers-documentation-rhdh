...
include::modules/techdocs/proc-remove-an-external-techdocs-add-on-from-your-configmap.adoc[leveloffset=+1]

include::modules/techdocs/proc-remove-an-external-techdocs-add-on-from-your-helm-chart.adoc[leveloffset=+1]
