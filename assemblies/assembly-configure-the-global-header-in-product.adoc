...
include::modules/customizing/proc-customize-your-product-global-header.adoc[leveloffset=+1]


include::modules/customizing/ref-mount-points-for-dynamic-plugin-integration.adoc[leveloffset=+1]

include::modules/customizing/proc-configure-the-logo-in-the-global-header.adoc[leveloffset=+1]

include::modules/customizing/proc-enable-logo-in-the-sidebar.adoc[leveloffset=+1]

include::modules/customizing/proc-display-the-preferred-username-in-the-profile-dropdown.adoc[leveloffset=+1]

include::modules/customizing/con-quicklinks-and-starred-items-in-the-global-header.adoc[leveloffset=+1]

include::modules/customizing/proc-enable-quicklinks-and-starred-items-after-an-upgrade.adoc[leveloffset=+1]
