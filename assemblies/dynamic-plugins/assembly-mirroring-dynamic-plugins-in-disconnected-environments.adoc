...
You can use the `mirror-plugins.sh` script to mirror dynamic plugin OCI artifacts for deployments in restricted environments.
...
//See link:TBC[{product}] documentation for configuration details.
