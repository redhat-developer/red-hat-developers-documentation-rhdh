...
For Operator deployments, you must configure the Backstage Custom Resource with the mirrored plugin references. For Helm deployments, you must update your values file with the mirrored plugin references. See link:TBC[Red Hat Developer Hub] documentation for configuration details.
