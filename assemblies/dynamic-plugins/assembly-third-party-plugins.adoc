...
= Converting custom plugins to dynamic plugins in {product}
:context: assembly-third-party-plugins

You can integrate custom plugins into {product} to enhance its functionality without modifying its source code or rebuilding it. To add these plugins, export them as derived packages.
