...
// Note about plugins that have migrated to a Community support level and switched from wrapper to oci://ghcr.io reference
// TODO: this generated content will need to change in 1.10 and again in subsequent releases
[id="rhdh-community-plugins-migration"]
include::../modules/dynamic-plugins/ref-community-plugins-migration.adoc[leveloffset=+1]
