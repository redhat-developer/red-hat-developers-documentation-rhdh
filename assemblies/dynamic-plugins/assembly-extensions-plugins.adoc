...
include::../modules/dynamic-plugins/proc-extensions-enabling-plugins-installation.adoc[leveloffset=+1]

// Installing plugins by using Extensions
include::../modules/dynamic-plugins/proc-extensions-installing-plugins.adoc[leveloffset=+1]
