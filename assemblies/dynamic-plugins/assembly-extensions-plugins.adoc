...
Your {product} ({product-very-short}) instance includes the Extensions feature preinstalled and enabled by default. Your organization can use Extensions to discover plugins which are modular extensions for {product-very-short} that extend functionality, streamline development workflows, and improve the developer experience.
...
include::../modules/dynamic-plugins/ref-catalog-plugin.adoc[leveloffset=+1]
