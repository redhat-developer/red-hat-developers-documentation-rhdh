...
// Plugins dependency
include::../modules/dynamic-plugins/con-dynamic-plugins-dependencies.adoc[leveloffset=+1]
...
// Mirroring RHDH dynamic plugins in disconnected environments
include::assembly-mirroring-dynamic-plugins-in-disconnected-environments.adoc[leveloffset=+1]
