...
include::modules/installation/proc-install-rhdh-in-a-fully-disconnected-environment-ocp-helm.adoc[leveloffset=+1]

include::modules/installation/proc-install-rhdh-in-a-partially-disconnected-environment-ocp-helm.adoc[leveloffset=+1]