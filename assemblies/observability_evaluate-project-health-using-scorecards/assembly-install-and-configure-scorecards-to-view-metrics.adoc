...
include::../modules/observability_evaluate-project-health-using-scorecards/proc-exclude-specific-scorecard-metrics-per-entity.adoc[leveloffset=+1]

include::../modules/observability_evaluate-project-health-using-scorecards/proc-exclude-or-include-scorecard-metrics-globally.adoc[leveloffset=+1]

include::../modules/observability_evaluate-project-health-using-scorecards/ref-available-scorecard-metric-ids.adoc[leveloffset=+1]
