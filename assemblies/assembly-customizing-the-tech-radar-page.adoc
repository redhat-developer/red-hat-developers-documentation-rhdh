...
include::modules/customizing-the-tech-radar-page/proc-customize-the-tech-radar-page-by-using-a-json-file.adoc[leveloffset=+1]

include::modules/customizing-the-tech-radar-page/proc-customize-the-tech-radar-page-by-using-a-customization-service.adoc[leveloffset=+1]
