...
include::modules/analytics/proc-customize-segment-source-using-the-operator.adoc[leveloffset=+1]

include::modules/analytics/proc-customize-segment-source-using-the-helm-chart.adoc[leveloffset=+1]
