...
[role="_abstract"]
Customize your {product} environment using the extension-based front-end system to improve extensibility and performance. This system provides better customization options for themes, navigation, and plugin integration compared to the older Scalprum-based approach.
