...
{company-name} analyzes the collected data to understand your interactions with the application and to improve the offerings and your experience with {product}.
...
IP address and username are anonymized:
