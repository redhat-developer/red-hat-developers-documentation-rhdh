...
// disabling telemetry
include::modules/analytics/ref-disabling-telemetry.adoc[leveloffset=+1]

include::modules/analytics/proc-disabling-telemetry-using-operator.adoc[leveloffset=+2]

include::modules/analytics/proc-disabling-telemetry-using-helm.adoc[leveloffset=+2]

// enabling telemetry
include::modules/analytics/ref-enabling-telemetry.adoc[leveloffset=+1]

include::modules/analytics/proc-enabling-telemetry-using-operator.adoc[leveloffset=+2]

include::modules/analytics/proc-enabling-telemetry-using-helm.adoc[leveloffset=+2]

// customizing telemetry segment source
include::modules/analytics/ref-customizing-telemetry-segment.adoc[leveloffset=+1]

include::modules/analytics/proc-customizing-telemetry-segment-using-operator.adoc[leveloffset=+2]

include::modules/analytics/proc-customizing-telemetry-segment-using-helm.adoc[leveloffset=+2]
