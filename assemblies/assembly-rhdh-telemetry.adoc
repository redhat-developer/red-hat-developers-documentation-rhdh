...
The usernames denote a unique random identifier that is used solely to identify the number of unique users of the {product-very-short} application.
...
[IMPORTANT]
====
You can also customize the telemetry data collection feature and the telemetry Segment source configuration in an air-gapped environment. For more information, see the following procedures.
====
