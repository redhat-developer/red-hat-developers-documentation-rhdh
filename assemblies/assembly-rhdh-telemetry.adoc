...
{company-name} analyzes collected data to understand your interactions with the application, and to improve offerings and your experience with {product}.
...
* Anonymized username hashes - a unique identifier used solely to identify the number of unique users of the {product-very-short} application.
