...
include::../modules/shared/proc-enable-servicenow-custom-actions-plugin-in-red-hat-developer-hub.adoc[leveloffset=+1]

include::../modules/shared/ref-supported-servicenow-custom-actions-in-red-hat-developer-hub.adoc[leveloffset=+1]
