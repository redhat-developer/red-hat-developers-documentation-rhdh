...
include::../modules/shared/modules/shared/configure-the-servicenow-plugin-in-the-configmap.adoc[leveloffset=+2]

//include::../modules/shared/proc-linking-servicenow-entities.adoc[leveloffset=+2] 
