...
. Search for Developer Hub or Backstage in the search bar and select the *Red Hat Developer Hub* card.
. Click *Create*.
. Optionally, configure the {product} instance with non-default settings.
. Click *Create*.
