...
* You have installed an {ocp-brand-name} ({ocp-short}) {ocp-version-min} or later.
* You have access to the `registry.redhat.io`.
* You have access to the {ocp-short} image registry of your cluster. For more information about exposing the {ocp-short} image registry, see https://docs.openshift.com/container-platform/{ocp-version}/registry/securing-exposing-registry.html[Exposing the registry] in OpenShift documentation.
