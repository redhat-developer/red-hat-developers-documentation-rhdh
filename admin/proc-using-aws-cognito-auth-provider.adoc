...
. Optional: If you have an existing {product-short} instance backed by the Custom Resource and you have not edited it, you can manually delete the {product-short} deployment to recreate it using the operator. Run the following to delete the {product-short} deployment:
+
[source,bash]
----
