...
include::proc-rhdh-deploy-aks.adoc[leveloffset=+1]

include::proc-rhdh-deploy-aks-using-helm.adoc[leveloffset=+2]

include::proc-rhdh-deploy-aks-using-operator.adoc[leveloffset=+2]

include::proc-rhdh-monitoring-logging-aks.adoc[leveloffset=+1]

include::proc-using-azure-auth-provider.adoc[leveloffset=+1]
