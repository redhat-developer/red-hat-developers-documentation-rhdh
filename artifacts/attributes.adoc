...
// Links
:LinkAdminGuide: https://access.redhat.com/documentation/en-us/red_hat_fuse/{product-version}/html-single/administration_guide_for_red_hat_developer_hub/index
