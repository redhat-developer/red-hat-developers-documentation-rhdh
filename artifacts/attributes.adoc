...
:install-on-ocp-book-title: Installing {product} on {ocp-short}
...
:install-on-eks-book-title: Installing {product} on {eks-brand-name}
...
:install-on-aks-book-title: Installing {product} on {aks-brand-name}
...
:install-in-air-gap-book-title: Installing {product} in an air-gapped environment
...
:upgrade-book-title: Upgrading {product}