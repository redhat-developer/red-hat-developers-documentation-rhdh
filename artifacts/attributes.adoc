...
//:LinkInstallGuide: https://access.redhat.com/documentation/en-us/red_hat_developer_hub/{product-version}/html-single/installing_red_hat_developer_hub/index
//:NameOfAdminGuide: Installing {product}
