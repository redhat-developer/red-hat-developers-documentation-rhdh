...
:my-app-config-config-map: my_rhdh_app_config
:my-app-config-file: app-config.yaml
:my-product-cr-name: my_rhdh_custom_resource
:my-product-namespace: my_rhdh_project
:my-product-secrets: my_rhdh_secrets
:my-product-database-certificates-secrets: my_rhdh_database_certificates_secrets
:my-product-database-secrets: my_rhdh_database_secrets
:my-product-url: https://__<my_developer_hub_url>__
:my-extra-file-configmap: my_project_configmap
