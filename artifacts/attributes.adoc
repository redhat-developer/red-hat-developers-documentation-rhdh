...
:authentication-book-url: https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.2/html/installing_red_hat_developer_hub_on_openshift_container_platform/index
:authentication-book-title: Installing Red Hat Developer Hub on OpenShift Container Platform

:authorization-book-url: https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.2/html/installing_red_hat_developer_hub_on_amazon_elastic_kubernetes_service/index
:authorization-book-title: Installing Red Hat Developer Hub on Amazon Elastic Kubernetes Service

:authorization-book-url: https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.2/html/installing_red_hat_developer_hub_on_microsoft_azure_kubernetes_service/index
:authorization-book-title: Installing Red Hat Developer Hub on Microsoft Azure Kubernetes Service

:authorization-book-url: https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.2/html/installing_red_hat_developer_hub_in_an_air-gapped_environment/index
:authorization-book-title: Installing Red Hat Developer Hub in an air-gapped environment

:authorization-book-url: https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.2/html/upgrading_red_hat_developer_hub/index
:authorization-book-title: Upgrading Red Hat Developer Hub