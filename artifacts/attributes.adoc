...
:gke-short: GKE
:kserve-kubeflow-connector-name-short: KServe/Kubeflow Connector for {product-very-short}
:kserve-kubeflow-connector-name: KServe/Kubeflow Connector for {product}
...
:kserve-kubeflow-connector-for-rhdh-book-link: {product-docs-link}/html-single/accelerate_ai_development_with_kserve_kubeflow_connector_for_red_hat_developer_hub/index
:kserve-kubeflow-connector-for-rhdh-book-title: Accelerate AI development with {kserve-kubeflow-connector-name}
...
:using-the-rhdh-cli-book-link: {product-docs-link}/html-single/querying_and_managing_red_hat_developer_hub_with_the_rhdh-cli_command-line_interface/index
:using-the-rhdh-cli-book-title: Querying and managing {product} with the {product-cli} command-line interface
