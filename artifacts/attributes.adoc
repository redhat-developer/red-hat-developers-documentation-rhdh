...
:setting-up-and-configuring-your-first-rhdh-instance-link: {product-docs-link}/html-single/setting_up_and_configuring_your_first_red_hat_developer_hub_instance/index
:setting-up-and-configuring-your-first-rhdh-instance-title: Setting up and configuring your first {product} instance
