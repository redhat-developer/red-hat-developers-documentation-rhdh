...
:upgrade-helper-skill-book-link: {product-docs-link}/html-single/assessing_upgrade_risk_with_the_rhdh_upgrade_helper_skill/index
:upgrade-helper-skill-book-title: Assessing upgrade risk with the {product-very-short} Upgrade Helper skill
