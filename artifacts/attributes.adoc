...
:querying-rhdh-with-the-backstage-cli-book-title: Querying {product} with the {backstage} CLI
:querying-rhdh-with-the-backstage-cli-book-link: {product-docs-link}/html-single/querying_red_hat_developer_hub_with_the_backstage_cli/index
