...
// minimum and current latest supported versions - see Supported Platforms at https://access.redhat.com/support/policy/updates/developerhub for the current list
:ocp-version-min: 4.13
:ocp-version: 4.15
