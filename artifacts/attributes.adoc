...
:install-on-ocp-book-url: https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.2/html/installing_red_hat_developer_hub_on_openshift_container_platform/index
:install-on-ocp-book-title: Installing Red Hat Developer Hub on OpenShift Container Platform

:install-on-aeks-book-url: https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.2/html/installing_red_hat_developer_hub_on_amazon_elastic_kubernetes_service/index
:install-on-aeks-book-title: Installing Red Hat Developer Hub on Amazon Elastic Kubernetes Service

:install-on-ms-azure-ks-book-url: https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.2/html/installing_red_hat_developer_hub_on_microsoft_azure_kubernetes_service/index
:install-on-ms-azure-ks-book-title: Installing Red Hat Developer Hub on Microsoft Azure Kubernetes Service

:install-in-air-gap-book-url: https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.2/html/installing_red_hat_developer_hub_in_an_air-gapped_environment/index
:install-in-air-gap-book-title: Installing Red Hat Developer Hub in an air-gapped environment

:upgrade-book-url: https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.2/html/upgrading_red_hat_developer_hub/index
:upgrade-book-title: Upgrading Red Hat Developer Hub