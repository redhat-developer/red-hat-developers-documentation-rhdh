...
//:LinkInstallGuide: https://access.redhat.com/documentation/en-us/red_hat_developer_hub/{product-version}/html-single/installation_guide_for_red_hat_developer_hub/index
//:NameOfAdminGuide: Installation guide for {product}
