...
:ls-brand-name: Red Hat Developer Hub intelligent assistant
:ls-short: Developer Hub intelligent assistant
...
:developer-lightspeed-book-link: {product-docs-link}/html-single/interacting_with_red_hat_developer_hub_intelligent_assistant/index
