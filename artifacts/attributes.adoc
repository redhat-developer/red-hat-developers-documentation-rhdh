...
:product-version: 2.1
:product-bundle-version: 2.1.0
:product-chart-version: 2.1.0
:product-backstage-version: 1.54.6
:product-version-next: 2.2
...
// k8s and OCP min versions are aligned (OCP 4.19 is based on k8s 1.32)
:kubernetes-version: 1.32
:ocp-version-min: 4.19
:ocp-version: 4.21
:osd-version: 4
...
:ai-catalog-book-link: {product-docs-link}/html-single/discovering_ai_assets_in_the_ai_catalog/index
:ai-catalog-book-title: Discovering AI assets in the AI Catalog
