...
For example, for {product-very-short} {product-version} based on {backstage} {product-backstage-version}, use the format `pass:c,a,q[bs_{product-backstage-version}__<plugin-version>]`.
+
[TIP]
====
