...
* The package path, scope, and name of the {company-name} ArgoCD plugin has changed since 1.2. For more information, see link:{LinkReleaseNotes}#removed-functionality-rhidp-4293[Breaking Changes] in the _{rn-product-title}_. 
