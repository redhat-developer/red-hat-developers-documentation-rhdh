...
* Note that the package path, scope, and name of the Red Hat ArgoCD plugin has changed since 1.2. For more information, see link:{LinkReleaseNotes}#removed-functionality-rhidp-4293[Breaking Changes] in the _{rn-product-title}_. 

* For more information on dynamic plugins, see link:{LinkPluginsGuide}#rhdh-installing-dynamic-plugins[Dynamic plugin installation] in the _{NameOfPluginsGuide}_ guide.
