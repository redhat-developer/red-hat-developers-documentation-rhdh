...
. Click the expand row button besides PipelineRun name in the list to view the software supply chain security elements in a PipelineRun. The pipeline run resource includes tasks to complete. When you hover the mouse pointer on a task card, you can view the steps to complete that particular task.
+
...
[NOTE]
====
You must set up OpenShift Pipelines in the web console to view Software Supply Chain Security elements. For set up instructions, refer to xref:proc_setting-up-openshift-pipelines-in-the-web-console-to-view-software-supply-chain-security-elements.adoc[Setting up OpenShift Pipelines in the web console to view Software Supply Chain Security elements]
====
