...
For additional information about installing and configuring dynamic plugins, see the xref:rhdh-installing-dynamic-plugins[Installing dynamic plugins] section.
