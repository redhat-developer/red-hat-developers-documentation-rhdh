...
For additional information about installing and configuring dynamic plugins, see the xref:con-rhdh-installing-dynamic-plugins_{context}[Installing dynamic plugins] section.
