...
[id="create-a-techdocs-add-on_{context}"]
= Create a TechDocs add-on
...
. Install and configure your new TechDocs add-on by following the steps in {techdocs-book-link}#install-and-configure-a-techdocs-add-on[Install and configure a TechDocs add-on]
