...
Clicking the name of a document in the table on the *Documentation* page opens the document in a book page. The name of the book is displayed at the top of the page. The book page contains the following elements:
...
. In the table, click the name of the document that you want to view on the book page.
. In the document, you can do any of the following optional actions:
...
* Navigate to the sections that you want to view in any of the following ways:
