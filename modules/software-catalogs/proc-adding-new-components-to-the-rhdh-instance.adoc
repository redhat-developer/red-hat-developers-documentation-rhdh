...
* Use the bulk import plugin with the required permissions. For more information, see {configuring-dynamic-plugins-book-url}#bulk-importing-github-repositories[Bulk importing GitHub repositories].
