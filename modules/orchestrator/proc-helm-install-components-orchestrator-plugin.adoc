...
. Manually approve the install plans for the Operators. You must run the `oc patch istallplan` commands provided in the output to approve their installation.
