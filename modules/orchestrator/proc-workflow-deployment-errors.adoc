...
Follow the link:https://sonataflow.org/serverlessworkflow/main/cloud/operator/add-custom-ca-to-a-workflow-pod.htmlspecialized[SonataFlow guide] for information on how to load the additional CA certificate into the workflow container.