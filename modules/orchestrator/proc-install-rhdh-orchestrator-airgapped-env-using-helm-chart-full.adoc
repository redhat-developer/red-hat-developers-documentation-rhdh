...
orchestrator:
  plugins:
    - package: oci://<custom_registry_url>/rhdh/red-hat-developer-hub-backstage-plugin-orchestrator:{{inherit}}
      disabled: true
      pluginConfig:
        orchestrator:
          dataIndexService:
            url: http://sonataflow-platform-data-index-service
    - package: oci://<custom_registry_url>/rhdh/red-hat-developer-hub-backstage-plugin-orchestrator-form-widgets:{{inherit}}
      disabled: true
      pluginConfig:
        dynamicPlugins:
          frontend:
    ...
    - package: oci://<custom_registry_url>/rhdh/red-hat-developer-hub-backstage-plugin-scaffolder-backend-module-orchestrator:{{inherit}}
      disabled: true
      pluginConfig:
        orchestrator:
          dataIndexService:
