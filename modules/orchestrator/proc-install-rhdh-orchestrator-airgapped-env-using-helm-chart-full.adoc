...
====
+
. Transfer the generated mirror archive file, for example, `/path/to/mirror-archive/mirror_seq1_000000.tar`, to a bastion host within your disconnected environment.
