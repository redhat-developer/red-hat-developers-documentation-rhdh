...
[IMPORTANT]
====
Orchestrator Infrastructure for {product} Helm chart is suitable for production use. By default, it does *not* auto-install or auto-upgrade the required Serverless Operators: you or a cluster administrator must approve the install plans.
====