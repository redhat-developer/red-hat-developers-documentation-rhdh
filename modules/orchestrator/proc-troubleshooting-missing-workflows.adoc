...
. Check the {product-very-short} pod connection to the Data Index service. Inspect the logs of the {product-very-short} pod for messages from the Orchestrator plugin.
...
. Verify that the Data Index properties file contains the correct settings:
+
[source,yaml]
----
