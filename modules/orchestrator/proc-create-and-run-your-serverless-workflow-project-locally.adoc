...
----
registry.redhat.io/openshift-serverless-1/logic-swf-devmode-rhel9:{rhoserverless-version}
----
...
[source,yaml,subs=+attributes,+quotes]
----
registry.redhat.io/openshift-serverless-1/logic-swf-builder-rhel9:{rhoserverless-version}
