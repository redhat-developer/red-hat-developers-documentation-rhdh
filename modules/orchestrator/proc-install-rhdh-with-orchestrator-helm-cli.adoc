...
* You can install the necessary infrastructures resources, such as other {platform-generic} operators (OpenShift Serverless and OpenShift Serverless Logic), alongside {product-very-short} in the same namespace.
+
