...
. Optional: Modify your Helm `values.yaml` file (or the corresponding configuration within your {product-custom-resource-type} Custom Resource) to explicitly list the Orchestrator dynamic plugin packages using simplified package references.
+
[NOTE]
====
