...
[id="configuring-ci-cd-to-generate-and-publish-techdocs-sites_{context}"]
...
TechDocs reads the static generated documentation files from a cloud storage bucket, such as {odf-name}. The documentation site is generated on the CI/CD workflow associated with the repository that has the documentation files.
