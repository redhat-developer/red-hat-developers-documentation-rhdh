...
* You have set up the {openshift-ai-connector-name} with {rhoai-brand-name}. For more information, see xref:set-up-openshift-ai-connector-for-red-hat-developer-hub-with-red-hat-openshift-ai_{context}[Set up {openshift-ai-connector-name} with {rhoai-brand-name}].
