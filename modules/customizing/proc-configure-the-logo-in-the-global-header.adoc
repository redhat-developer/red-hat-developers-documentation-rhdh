...
When defining menu items or links in the global header, you must specify an icon key. For the full list of available keys, see {customizing-book-link}#ref-common-icons[Common icons for customization].
