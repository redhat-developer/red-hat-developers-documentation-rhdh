...
[id="configure-the-logo-in-the-global-header_{context}"]
= Configure the logo in the global header
...
When defining menu items or links in the global header, you must specify an icon identifier. For the full list of available icon identifiers, see {customizing-book-link}#ref-common-icons[Common icons for customization].
