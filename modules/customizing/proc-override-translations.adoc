...
* xref:localization-support-for-the-floating-action-button_configure-a-floating-action-button[Enabling floating button localization in {product-short}]
* xref:enable-localization-in-quickstarts_customize-the-quick-start-plugin[Enable quick start localization in {product-short}]
* xref:enable-localization-in-sidebar-menu-items_customize-rhdh-appearance[Enabling sidebar menu items localization in {product-short}]
