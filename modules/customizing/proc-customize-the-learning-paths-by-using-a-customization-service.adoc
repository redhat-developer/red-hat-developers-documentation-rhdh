...
[id="customize-the-learning-paths-by-using-a-customization-service_{context}"]
= Customize the Learning Paths by using a customization service

[role="_abstract"]
For advanced scenarios, you can host your {product} customization service to provide data to all configurable {product-short} pages, such as the Learning Paths. You can even use a different service for each page.
