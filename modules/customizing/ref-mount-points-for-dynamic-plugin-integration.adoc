...
[id="mount-points-for-dynamic-plugin-integration_{context}"]
= Mount points for dynamic plugin integration

[role="_abstract"]
You can customize the application header in {product-short} using mount points for dynamic plugins. These mount points give flexibility in configuring the position of the header, its components, and dropdown menus.
