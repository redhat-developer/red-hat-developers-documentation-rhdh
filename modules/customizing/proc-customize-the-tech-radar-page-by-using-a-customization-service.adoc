...
[id='customize-the-tech-radar-page-by-using-a-customization-service_{context}']
= Customize the Tech Radar page by using a customization service

[role="_abstract"]
For advanced scenarios, you can host your {product} customization service to provide data to all configurable {product-short} pages, such as the Tech Radar page. You can even use a different service for each page.
