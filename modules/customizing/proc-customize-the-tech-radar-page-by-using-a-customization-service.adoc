...
[role="_abstract"]
For advanced scenarios, you can host your {product} customization service to offer data to all configurable {product-short} pages, such as the Tech Radar page. You can even use a different service for each page.
