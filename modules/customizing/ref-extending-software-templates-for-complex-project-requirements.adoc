...
[id="extending-software-templates_{context}"]
= Extending software templates for complex project requirements

[role="_abstract"]
Use advanced logic to create Software Templates that adapt to specific project requirements and user inputs. Advanced templating includes parameterization, conditional logic, and fetch-and-execute capabilities.
