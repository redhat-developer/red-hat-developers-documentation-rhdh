...
[id="how-templates-automate-project-setup_{context}"]
...
Steps::
Sequence of steps that the system performs to build the project, such as fetching a repository skeleton, injecting parameters, and publishing the code to a Git provider.
