...
.. For a Helm-installed {product-very-short} instance, see {authorization-book-link}##defining-authorizations-in-external-files-by-using-helm[Defining authorizations in external files by using Helm].
