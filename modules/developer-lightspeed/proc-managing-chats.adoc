...
** *Dock to window*: A panel attaches to the right side of the screen. Activating this mode automatically hides the *Quickstart* panel.
** *Fullscreen*: A dedicated page opens for intensive chat sessions. You can bookmark this URL for direct access. 
** Optional: Toggle *Enable pinned chats* to enable or hide the pinned chats. This is enabled by default.
...
* The history list reflects renamed, pinned, or deleted entries.