...
image::rhdh-plugins-reference/chat-options[]
...
+
image::rhdh-plugins-reference/lightspeed-overlay[]
...
+
image::rhdh-plugins-reference/lightspeed-fullscreen[]
...
+
image::rhdh-plugins-reference/lightspeed-attachment[]
...
+
image::rhdh-plugins-reference/rename-chat[]
...
+
image::rhdh-plugins-reference/sorting-chat[]

** *Delete a chat*: Click *Options* next to a chat title and select *Delete*.
+
image::rhdh-plugins-reference/delete-chat[]
