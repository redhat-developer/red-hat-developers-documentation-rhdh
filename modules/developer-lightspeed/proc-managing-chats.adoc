...
image::rhdh-plugins-reference/chat-options.png[]
...
+
image::rhdh-plugins-reference/settings.png[]

** *Overlay*: A floating window appears over the current page content.
+
image::rhdh-plugins-reference/lightspeed-overlay.png[]
...
+
image::rhdh-plugins-reference/lightspeed-docked-mode.png[]

** *Fullscreen*: A dedicated page opens for intensive chat sessions. You can bookmark this URL for direct access.
+
image::rhdh-plugins-reference/lightspeed-fullscreen.png[]
...
+
image::rhdh-plugins-reference/lightspeed-attachment.png[]
...
+
image::rhdh-plugins-reference/rename-chat.png[]
...
+
image::rhdh-plugins-reference/sorting-chat.png[]

** *Delete a chat*: Click *Options* next to a chat title and select *Delete*.
+
image::rhdh-plugins-reference/delete-chat.png[]
