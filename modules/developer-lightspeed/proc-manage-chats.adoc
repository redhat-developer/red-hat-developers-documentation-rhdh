...
image::rhdh-plugins-reference/chat-options.png["Chat options menu"]
...
+
image::rhdh-plugins-reference/settings.png["Display menu options"]

** *Overlay*: A floating window is displayed over the current page content.
+
image::rhdh-plugins-reference/lightspeed-overlay.png["Lightspeed overlay mode"]
...
+
image::rhdh-plugins-reference/lightspeed-docked-mode.png["Lightspeed docked mode"]

** *Fullscreen*: A dedicated page opens for intensive chat sessions. You can bookmark this URL for direct access.
+
image::rhdh-plugins-reference/lightspeed-fullscreen.png["Lightspeed full-screen mode"]
...
+
image::rhdh-plugins-reference/lightspeed-attachment.png["Lightspeed file attachment preview"]
...
+
image::rhdh-plugins-reference/rename-chat.png["Rename chat option"]
...
+
image::rhdh-plugins-reference/sorting-chat.png["Chat sorting options"]

** *Delete a chat*: Click *Options* next to a chat title and select *Delete*.
+
image::rhdh-plugins-reference/delete-chat.png["Delete chat option"]
