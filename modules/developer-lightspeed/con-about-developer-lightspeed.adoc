...
You can experience {{ls-short} Developer Preview by installing the Developer Lightspeed for {product} plugin within an existing {product-very-short} instance. Or, if you prefer a more local test first, you can try {ls-short} using link:https://github.com/redhat-developer/rhdh-local[{product-local-very-short}].
