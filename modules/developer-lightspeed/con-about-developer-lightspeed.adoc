...
You can experience {ls-short} Developer Preview by installing the {ls-short} plugin within an existing {product-very-short} instance.
...
image::rhdh-plugins-reference/homepage-lightspeed-fab.png[]
