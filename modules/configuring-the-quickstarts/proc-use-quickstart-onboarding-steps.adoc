...
[id='proc-use-quickstart-onboarding-steps_{context}']
...
.Procedure
To start a quick start step in {product}, complete the following steps:
...
+
image::rhdh/about-quickstarts.png[About quick starts]
+
[NOTE]
====
