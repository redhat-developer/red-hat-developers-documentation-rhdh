...
`icon`:: (Optional) Enter the icon identifier. You can use a full image URL, a valid SVG path, or one of the {customizing-book-link}#ref-common-icons[Common icons for customization].