...
`icon`:: (Optional) Enter the icon identifier. Use an identifier from the link:https://mui.com/material-ui/material-icons/?query=book#search-material-icons[Material UI icons] library or one of the following common keys:
+
* `home`
* `group`
* `category`
