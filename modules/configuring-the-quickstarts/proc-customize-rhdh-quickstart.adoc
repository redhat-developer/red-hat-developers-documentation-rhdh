...
`icon`:: (Optional) Enter the icon identifier. You can use a full image URL, a valid SVG path, or one of the list of {customizing-book-link}#ref-common-icons[common icons for customization].