...
`icon`:: (Optional) Enter the icon identifier from the link:https://mui.com/material-ui/material-icons/?query=book#search-material-icons[Material UI icons] library.
