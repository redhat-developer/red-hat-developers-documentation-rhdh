...
|Bitbucket |Backend |@backstage/plugin-catalog-backend-module-bitbucket-cloud |A Backstage catalog backend module that helps integrate towards Bitbucket Cloud. |0.1.28 |Community Support |dynamic-plugins/wrappers/backstage-plugin-catalog-backend-module-bitbucket-cloud | |Disabled

|Bitbucket |Backend |@backstage/plugin-catalog-backend-module-bitbucket-server |A Backstage catalog backend module that helps integrate towards Bitbucket Server. |0.1.26 |Community Support |dynamic-plugins/wrappers/backstage-plugin-catalog-backend-module-bitbucket-server | |Disabled
