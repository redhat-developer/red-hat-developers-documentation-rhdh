...
|RBAC |Frontend |@janus-idp/backstage-plugin-rbac |RBAC frontend plugin for Backstage. |1.15.3 | Production | ./dynamic-plugins/dist/janus-idp-backstage-plugin-rbac | | Disabled
