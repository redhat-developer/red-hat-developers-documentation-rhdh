...
Backstage catalog. |1.3.6 |Tech Preview
...
|AAP |Backend |@janus-idp/backstage-plugin-aap-backend | |1.4.5 |Tech
Preview
...
|ACR |Frontend |@janus-idp/backstage-plugin-acr | |1.2.4 |Tech Preview
...
Artifactory registry. |1.2.4 |Tech Preview
...
provides Backstage template actions for ServiceNow. |1.2.3 |Tech Preview
...
provides Backstage template actions for SonarQube. |1.2.1 |Tech Preview
