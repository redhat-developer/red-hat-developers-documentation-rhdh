...
== Helm deployment
To deploy a RHDH (Red Hat Developer Hub) instance, you use a Helm Chart which is a flexible installation method.
...
== Advanced configuration of dynamic plugins
TBD