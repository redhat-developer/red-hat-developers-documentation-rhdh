...
[id="proc-enabling-encryption-and-database-storage-for-mcp_{context}"]
= Enabling encryption and database storage for MCP server tokens
...
* You have a generated `${BACKEND_SECRET}`.
