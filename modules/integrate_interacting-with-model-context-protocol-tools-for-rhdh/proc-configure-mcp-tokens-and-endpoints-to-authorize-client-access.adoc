...
* link:https://github.com/redhat-ai-dev/rhdh-mcp-eval[rhdh-mcp-eval] — MCP evaluation results for {product-short} AI integrations (see the `evaluation-result/` directory).
