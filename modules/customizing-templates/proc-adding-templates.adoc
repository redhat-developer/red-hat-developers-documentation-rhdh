...
* Optional: To use a template stored in a GitHub repository, you link:{integrating-with-github-book-url}[have configured {product-short} integration with GitHub].
