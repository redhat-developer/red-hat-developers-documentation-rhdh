...
* Resources may contain *{{backstage-name}}* and *{{backstage-ns}}* placeholders.
The *{{backstage-name}}* placeholder will be replaced with the name of the {backstage} CR, and the *{{backstage-ns}}* placeholder will be replaced with the namespace of the {backstage} CR.
====
