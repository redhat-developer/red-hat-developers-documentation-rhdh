...
[WARNING]
====
The derived dynamic plugin JavaScript packages must not be published to the public NPM registry. For more appropriate packaging options, see xref:package-and-publish-plugins-as-dynamic-plugins_plugins-in-rhdh[]. If you must publish to the NPM registry, use a private registry.
====
--
