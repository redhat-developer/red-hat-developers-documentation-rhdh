...
[role="_abstract"]
To locate resources, manage projects, and customize your workspace, use the two primary navigation areas in {product} ({product-very-short}). By understanding these regions, you can navigate the software ecosystem and run development tasks efficiently.
