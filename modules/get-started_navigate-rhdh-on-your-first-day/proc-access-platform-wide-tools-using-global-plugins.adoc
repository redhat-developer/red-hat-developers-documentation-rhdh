...
[role="_abstract"]
To manage technology standards, track project costs, or access AI help, use the global plugins located in the main navigation sidebar of {product} ({product-very-short}). These plugins give features that apply across the whole portal instead of to a specific software entity.
