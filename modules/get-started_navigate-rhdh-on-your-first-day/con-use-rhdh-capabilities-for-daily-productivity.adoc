...
[id="use-rhdh-capabilities-for-daily-productivity_{context}"]
= Use {product-very-short} capabilities for daily productivity

[role="_abstract"]
To streamline your software development lifecycle, use the integrated tools within {product} ({product-very-short}). You can use these core capabilities to perform self-service tasks and discover organizational resources from a centralized interface.
