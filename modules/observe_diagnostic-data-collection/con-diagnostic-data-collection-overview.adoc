...
Use must-gather when opening a support ticket with {company-name} Global Support Services, troubleshooting deployment issues, or capturing deployment state before {product-very-short} upgrades.
