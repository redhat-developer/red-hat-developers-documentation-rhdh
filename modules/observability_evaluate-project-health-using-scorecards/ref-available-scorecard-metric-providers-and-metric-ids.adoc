...
For more information, see xref:dora-metrics-in-scorecard_{context}[How DORA metrics measure delivery performance] and xref:install-configure-dora-backend-module_{context}[Install and configure the DORA backend module].
====
