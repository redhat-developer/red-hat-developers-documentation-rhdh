...
For more information, see xref:dora-metrics-in-scorecard_{context}[How DORA metrics measure delivery performance] and xref:install-configure-dora-backend-module_install-and-configure-scorecards[Install and configure the DORA backend module].
====
