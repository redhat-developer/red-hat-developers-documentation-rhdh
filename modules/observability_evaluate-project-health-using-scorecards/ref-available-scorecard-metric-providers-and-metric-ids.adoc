...
| Whether the project passes its SonarQube quality gate.
| boolean

| SonarQube
| `sonarqube.openIssues`
| SonarQube Open Issues
| Count of open issues (OPEN, CONFIRMED, REOPENED).
| number
...
| Count of open security vulnerabilities.
| number
...
| Count of security hotspots to review.
| number
