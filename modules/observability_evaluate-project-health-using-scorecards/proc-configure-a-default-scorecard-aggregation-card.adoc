...
`aggregationId`:: The aggregation identifier used in the mount point configuration. For default aggregations, this value must match the `metricId` from your installed Scorecard module. For more information, see link:https://access.redhat.com/documentation/en-us/red_hat_developer_hub/latest/html/evaluating_project_health_using_scorecards/index#supported-scorecard-metrics-providers[Supported Scorecard metrics providers].
