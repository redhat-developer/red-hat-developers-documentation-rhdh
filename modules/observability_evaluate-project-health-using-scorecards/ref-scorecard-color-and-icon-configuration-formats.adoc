...
For a complete list of available icon identifiers, see {customizing-book-link}#common-icons-for-customization_configure-the-global-header-in-rhdh[Common icons for customization].
====
