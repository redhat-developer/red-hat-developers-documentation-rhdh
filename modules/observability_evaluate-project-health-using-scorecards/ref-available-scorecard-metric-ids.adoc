...
| `filecheck._<key>_`
| Verifies that the configured file exists in the repository. The metric ID suffix is derived from the key you define in `scorecard.plugins.filecheck.files`.
|===
