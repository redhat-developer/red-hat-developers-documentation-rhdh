...
[id="monitoring-bulk-import-actions-using-audit-logs"]
...
See {audit-log-book-link}[{audit-log-book-title}] for more information on how to configure and view audit logs.
