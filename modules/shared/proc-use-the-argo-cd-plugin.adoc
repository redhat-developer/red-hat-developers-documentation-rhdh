...
+
image::extend_using-dynamic-plugins-in-rhdh/argocd.png[CD tab Argo CD]

. Select an appropriate card to view the deployment details (for example, commit message, author name, and deployment history).

+
image::extend_using-dynamic-plugins-in-rhdh/sidebar.png[Sidebar]
...
+
image::extend_using-dynamic-plugins-in-rhdh/deployment_summary.png[Deployment summary]
