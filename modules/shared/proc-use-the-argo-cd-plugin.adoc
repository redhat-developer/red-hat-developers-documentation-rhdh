...
.Prerequisites
* You have link:{configuring-dynamic-plugins-book-link}#enable-the-argo-cd-plugin_install-and-configure-argo-cd[enabled the Argo CD plugin] in {product-very-short}.
