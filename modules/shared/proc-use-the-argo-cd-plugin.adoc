...
+
image::extend_configuring-dynamic-plugins/argocd.png["CD tab showing Argo CD deployments"]

. Select an appropriate card to view the deployment details (for example, commit message, author name, and deployment history).
+
image::extend_configuring-dynamic-plugins/sidebar.png["Sidebar showing deployment details"]

.. Click the link icon (image:extend_configuring-dynamic-plugins/link.png[Link icon]) to open the deployment details in Argo CD.
...
+
image::extend_configuring-dynamic-plugins/deployment_summary.png["Deployment summary showing application deployment across namespaces"]
