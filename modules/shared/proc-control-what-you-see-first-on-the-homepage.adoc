...
[role="_abstract"]
Choose which templates and widgets you see when you log in by configuring the dynamic homepage plugin. You can use customizable layouts where you drag and resize cards, or fixed layouts with predefined positions.
