...
`default.main-menu-items`::
Configures the sidebar menu items. Include both `default.create` and `default.admin` entries to display the *Self-service* button and *Administration* menu item in the sidebar.
`position`::
