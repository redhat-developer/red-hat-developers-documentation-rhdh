...
`default.main-menu-items`::
Configure sidebar menu items. Use `default.create` with an empty `title` to hide the *Self-service* button. Use `default.admin` to configure the *Administration* menu item with title, text key, and icon.
`position`::
