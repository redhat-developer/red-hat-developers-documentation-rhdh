...
[id="configure-a-dynamic-plugin-menu-item-for-your-rhdh-instance_{context}"]
= Configure a dynamic plugin menu item for your {product-short} instance

[role="_abstract"]
You can configure dynamic plugin menu items to customize the sidebar navigation for your {product-short} instance.
