...
Otherwise, you can use an oci:// plugin reference, and the special `{{inherit}}` tag will fetch the latest compatible plugin - including its default configuration - for your current RHDH version.
