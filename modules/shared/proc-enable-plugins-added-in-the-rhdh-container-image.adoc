...
. Copy the package configuration from the link:https://github.com/redhat-developer/rhdh/blob/release-1.9/dynamic-plugins.default.yaml[`dynamic-plugins.default.yaml`] file.
