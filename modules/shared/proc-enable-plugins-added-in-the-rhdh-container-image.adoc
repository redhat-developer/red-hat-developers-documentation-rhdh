...
.Prerequisites
* You have access to the link:https://github.com/redhat-developer/rhdh/blob/main/default.packages.yaml[`default.packages.yaml`] file, which lists all preinstalled plugins and their default configuration.
