...
Alternatively, you can use an `oci://` plugin reference, and the special `{{inherit}}` tag will fetch the latest compatible plugin, including its default configuration, or your current {product-very-short} version.
