...
`title`:: Optional: The display title of the menu item. If you have already defined the title in the `dynamicRoutes` configuration under `menuItem.title`, you can omit it in the `menuItems` configuration.
