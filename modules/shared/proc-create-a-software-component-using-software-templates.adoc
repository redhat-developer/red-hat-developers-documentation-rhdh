...
+
--
image::rhdh/template-creation-successful.png["Successful template creation page"]
--
...
+
image::rhdh/template-creation-not-successful.png["Failed template creation page"]