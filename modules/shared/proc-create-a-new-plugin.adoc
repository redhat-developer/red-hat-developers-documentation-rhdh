...
[id="create-a-new-plugin_{context}"]
= Create a new plugin
...
. (Optional) To preview your plugin with {product-very-short} styling, configure the {product-very-short} theme package in the plugin:
+
[source,terminal]
--
...
+
[source,javascript,subs="+attributes,+quotes"]
--
// Import the {product-very-short} themes from the plugin
...
createDevApp()
  // ...
  // ...
  // Add {product-very-short} themes to the development harness
