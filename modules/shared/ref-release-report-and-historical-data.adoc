...
[id="ref-release-report-and-historical-data_{context}"]
= Release report and historical data

[role="_abstract"]
Use the link:https://github.com/redhat-ai-dev/developer-lightspeed-evaluation[latest Q&A dataset and evaluation results] to monitor the current performance of {ls-short}. Access version-specific branches that contain the datasets and evaluation results required to track improvements or regressions across product releases.
...
.Data locations for product releases
