...
. Optional: To protect configuration files like `lightspeed-stack.yaml`, `config.yaml`, or `rhdh-profile.py` from being overwritten during updates, use a custom ConfigMap:
+
[IMPORTANT]
====
