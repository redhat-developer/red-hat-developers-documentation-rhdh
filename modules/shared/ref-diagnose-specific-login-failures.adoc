...
[id="diagnose-specific-login-failures_{context}"]
...
[source]
----
catalog info Read 114 GitHub users and 22 groups in 3.4 seconds. Committing...
catalog info Committed 114 GitHub users and 22 groups in 0.0 seconds.
----
