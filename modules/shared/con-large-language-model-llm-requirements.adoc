...
{ls-short} supports only the inference providers that the underlying {lcs-short} service supports.

The following table lists the inference providers {ls-short} supports.
