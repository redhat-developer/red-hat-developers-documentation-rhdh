...
{ls-short} supports only the inference providers that are supported by the underlying {lcs-short} service.
...
* link:https://github.com/lightspeed-core/lightspeed-stack/blob/main/docs/devel_doc/providers.md#inference-providers[{lcs-short} inference providers]