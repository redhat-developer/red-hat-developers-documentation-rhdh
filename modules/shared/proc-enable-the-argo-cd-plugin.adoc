...
[NOTE]
====
The preceding configuration references environment variables (`ARGOCD_USERNAME`, `ARGOCD_PASSWORD`, `ARGOCD_INSTANCE1_URL`, `ARGOCD_AUTH_TOKEN`). For information about how to configure these secrets, see {product-docs-link}/html-single/configuring_red_hat_developer_hub/index#inject-extra-files-and-environment-variables-into-containers_configuring-rhdh[Inject extra files and environment variables into containers].
====
+
