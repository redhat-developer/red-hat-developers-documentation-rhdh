...
+
For the complete list of AI feature permissions, including Notebooks, MCP, and saved prompts, see {developer-lightspeed-book-link}#ai-feature-permissions_interacting-with-the-intelligent-assistant-for-rhdh[AI feature permissions].
