...
ifeval::["{context}" == "rhdh-extensions-plugins"]
= Configure {product-very-short} Local to install plugins by using Extensions

endif::[]

ifeval::["{context}" == "assembly-developing-and-deploying-plugins"]
