...
[id="add-video-content-to-enhance-techdocs_{context}"]
= Add video content to enhance TechDocs
...
* An administrator has configured your {aws-short} S3 bucket to store TechDocs sites.
