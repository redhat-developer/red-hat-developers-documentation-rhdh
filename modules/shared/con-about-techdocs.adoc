...
The {product} instance includes the TechDocs plugin preinstalled and enabled by default. You can also enhance your technical documentation experience with built-in TechDocs features and add-ons. For example:
