...
[id="configure-the-github-events-module-plugin_{context}"]

= Configure the GitHub Events Module plugin
...
* For GitHub Discovery only: You have enabled {integrating-with-github-book-link}#enabling-github-repository-discovery[GitHub Discovery].
