...
** *Fullscreen*: A dedicated page opens for intensive chat sessions. This mode displays a revised header containing the {ls-short} icon and a horizontal tab bar, which replaces the previous main menu. Bookmark the URL in your browser to save a direct link to the chat interface.
+
