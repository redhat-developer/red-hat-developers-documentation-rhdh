...
[NOTE]
====
To display user icons from external providers like Gravatar or GitLab, you must include the provider URLs in the `img-src` directive of your Content Security Policy (CSP).
====
.. Click *Create*.
