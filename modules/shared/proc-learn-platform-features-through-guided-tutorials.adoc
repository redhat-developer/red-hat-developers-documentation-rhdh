...
[role="_abstract"]
Add interactive quick start tutorials to {product} that guide you through key features with step-by-step walkthroughs automatically displayed on first visit and accessible from a *Quick start* sidebar button.
