...
For more information, see {integrating-with-your-git-provider-book-link}#configure-the-gitlab-integration_integrate-with-gitlab[Configure the GitLab integration].
