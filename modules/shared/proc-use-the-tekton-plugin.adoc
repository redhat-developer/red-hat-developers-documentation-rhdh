...
+
image::extend_configuring-dynamic-plugins/tekton-plugin-pipeline.png["CI tab showing Tekton PipelineRun resources"]
...
+
image::extend_configuring-dynamic-plugins/tekton-plugin-pipeline-expand.png["Expanded PipelineRun visualization showing task steps"]
