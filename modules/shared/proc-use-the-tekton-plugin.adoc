...
+
image::extend_using-dynamic-plugins-in-rhdh/tekton-plugin-pipeline.png[ci-cd-tab-tekton]
...
+
image::extend_using-dynamic-plugins-in-rhdh/tekton-plugin-pipeline-expand.png[ci-cd-tab-tekton]
