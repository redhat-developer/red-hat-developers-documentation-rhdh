...
.. If you are using the Tekton plugin that is pre-loaded in {product-very-short}, you must set the `disabled` property to `false`, and modify the plugin configuration as follows:
+
--
