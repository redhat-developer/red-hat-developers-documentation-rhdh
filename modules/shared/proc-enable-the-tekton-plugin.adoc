...
= Monitor continuous integration pipelines with Tekton
...
.Procedure
* To enable the Tekton plugin, set the `enabled` property to `true` in your `dynamic-plugins.yaml` file as follows:
+
