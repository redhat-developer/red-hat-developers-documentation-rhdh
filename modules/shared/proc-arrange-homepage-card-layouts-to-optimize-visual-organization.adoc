...
* Optional: For persona-based homepage configuration with group-based visibility controls, you enabled the homepage backend plugin.
+
--
...
----
plugins:
  - package: ./dynamic-plugins/dist/red-hat-developer-hub-backstage-plugin-homepage-backend-dynamic
    disabled: false
----
