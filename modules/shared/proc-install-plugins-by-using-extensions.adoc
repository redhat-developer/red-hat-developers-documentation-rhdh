...
+
image::extend_installing-and-viewing-plugins-in-rhdh/extensions-install-plugin-1.png[]
The code editor is displayed that displays the plugin default configuration.
. Update the plugin configuration, if necessary.
+
image::extend_installing-and-viewing-plugins-in-rhdh/extensions-install-plugin-2.png[]
. Click *Install*
. To view the plugins that require a restart, click *View plugins* in the alert message.
+
image::extend_installing-and-viewing-plugins-in-rhdh/extensions-install-plugin-3.png[]
