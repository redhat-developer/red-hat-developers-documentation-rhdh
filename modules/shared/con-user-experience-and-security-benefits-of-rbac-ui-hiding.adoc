...
The evaluation mechanism supports the following features:
...
* *Feature flag evaluation:* The predicate supports feature flags, enabling gradual rollout or environment-based toggles.
