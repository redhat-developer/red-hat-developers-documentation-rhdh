...
image::extend_installing-and-viewing-plugins-in-rhdh/custom-limitations.png[]
...
image::extend_installing-and-viewing-plugins-in-rhdh/custom-container-images.png[]