...
For example, you can authenticate users with GitHub while provisioning user and group data from your LDAP directory.
...
You can authenticate users without provisioning them to the software catalog.
