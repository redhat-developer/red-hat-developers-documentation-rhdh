...
data:
  dynamic-plugins.yaml: |
    ...
    plugins:
      ...
      - package: 'oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/backstage-community-plugin-servicenow-backend:bs_1.49.4__1.10.0  '
        disabled: false
        pluginConfig:
          servicenow:
