...
** *Rename*: Click the notebook name to edit it inline. Click outside the field or press *Enter* to save the new name. Press *Escape* to discard your changes. Alternatively, hover over the notebook card, click the *More options* icon, and select *Rename*.
