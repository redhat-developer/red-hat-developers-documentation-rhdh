...
[role="_abstract"]
As an administrator, configure {product} and {ls-brand-name} to provide users with private, document-based AI workspaces.

.Prerequisites
* A deployed instance of {product-very-short}.
* A Llama Stack service is running and accessible to the backend.
