...
[id="design-your-policy-rules_{context}"]
= Design your policy rules

[role="_abstract"]
Design policy rules carefully to avoid permission conflicts and unintended access denials in {product-short}.
