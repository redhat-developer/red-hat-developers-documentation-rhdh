...
[IMPORTANT]
====
Deployments that previously relied on integration-only listing must configure SCM authentication providers and register `ScmAuthApi` for user authentication. See the Bulk Import plugin documentation for configuration details.
====
