...
** As your primary authentication provider for {product-short}.                                                                           
** As {authentication-book-link}#enabling-user-authentication-with-github-as-an-auxiliary-authentication-provider[an auxiliary              
  authentication provider] if you use another primary provider, for example, OIDC or Red Hat build of Keycloak.  
