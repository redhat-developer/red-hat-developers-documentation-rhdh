...
[id="migrate-the-homepage-to-function-as-a-dynamic-plugin-loaded-through-blueprints_{context}"]
= Migrate the Homepage to function as a dynamic plugin loaded through blueprints
...
export default createApp({
  features: [
    homePageModule,  // Enables the dynamic homepage plugin
