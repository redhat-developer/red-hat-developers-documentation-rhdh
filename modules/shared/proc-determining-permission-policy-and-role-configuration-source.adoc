...
Configuration file::
Configure roles and policies in the {product-short} `{my-app-config-file}` configuration file, for instance to xref:enabling-and-giving-access-to-rbac_{context}[declare your policy administrators].
+
