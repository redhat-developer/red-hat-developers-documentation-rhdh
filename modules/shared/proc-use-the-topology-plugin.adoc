...
+
image::extend_configuring-dynamic-plugins/topology-tab-user1.png["Topology tab showing workload nodes"]
...
+
image::extend_configuring-dynamic-plugins/topology-tab-user2.png["Node details and resources tabs"]

. Click the *Open URL* button on the top of a node.
+
image::extend_configuring-dynamic-plugins/topology-tab-user3.png["Open URL button on a topology node"]
+
