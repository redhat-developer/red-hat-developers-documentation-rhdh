...
+
image::extend_using-dynamic-plugins-in-rhdh/topology-tab-user1.png[topology-user-1]
...
+
image::extend_using-dynamic-plugins-in-rhdh/topology-tab-user2.png[topology-user-2]

. Click the *Open URL* button on the top of a node.
+
image::extend_using-dynamic-plugins-in-rhdh/topology-tab-user3.png[topology-user-3]
+
