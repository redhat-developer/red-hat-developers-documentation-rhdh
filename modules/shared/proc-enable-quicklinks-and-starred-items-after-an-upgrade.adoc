...
[id="enable-quicklinks-and-starred-items-after-an-upgrade_{context}"]
= Enable Quicklinks and starred items after an upgrade
...
. Operator deployment: The configuration is stored in a ConfigMap referenced by your {product-custom-resource-type} custom resource (CR).
