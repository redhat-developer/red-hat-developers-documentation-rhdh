...
For an example of using this command, see xref:example-of-installing-a-custom-plugin-in-rhdh_install-plugins-in-rhdh[Example of installing a custom plugin in {product}].
====
