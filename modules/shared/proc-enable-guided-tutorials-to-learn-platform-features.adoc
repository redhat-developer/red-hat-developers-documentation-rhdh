...
[role="_abstract"]
Enable guided tutorials in {product} to learn platform features through interactive quick start walkthroughs. Tutorials automatically display on first visit and are accessible from a *Quick start* sidebar button.
