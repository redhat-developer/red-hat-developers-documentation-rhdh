...
`githubUrl`::
Enter the GitHub URL by prepending the scheme to the configured hostname: `https://$\{GITHUB_HOST}`.
Unlike `integrations.github.host`, this field expects a full URL, including the scheme.
