...
[id="proc-set-up-the-evaluation-environment_{context}"]
...
By performing these evaluations, you minimise the risk of the model delivering incorrect or hallucinated information to users in production.

.Prerequisites

* You must install *uv* for Python package management (Python 3.11 or later).
