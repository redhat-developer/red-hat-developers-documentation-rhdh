...
+
If you add a file that is already present in the notebook, the system highlights the duplicate and prompts you to either *Replace the existing file* or *Skip the duplicate*.
+
...
`File size`:: Individual files or URL content must be 25 MB or smaller.
