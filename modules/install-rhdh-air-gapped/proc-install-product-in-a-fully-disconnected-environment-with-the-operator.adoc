...
If your network has access to the registry through a bastion host, you can use the helper script to install {product}. The script mirrors the Operator-related images to disk and transfers them to your air-gapped environment without any connection to the internet.
