...
Relative paths are resolved from the working directory of the `initContainer` that install the plugins.
|list
|["dynamic-plugins.default.yaml"]

|global.dynamic.includes[0]
|List of dynamic plugins included inside the {product-very-short} container image.
|string
|"dynamic-plugins.default.yaml"
