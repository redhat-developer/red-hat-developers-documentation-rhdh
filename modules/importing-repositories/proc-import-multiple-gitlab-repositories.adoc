...
[id="importing-multiple-repositories-from-gitlab_{context}"]
= Import multiple GitLab repositories

[role="_abstract"]
Select and import multiple GitLab projects to the {product-short} catalog by using Technology Preview bulk import capabilities.
