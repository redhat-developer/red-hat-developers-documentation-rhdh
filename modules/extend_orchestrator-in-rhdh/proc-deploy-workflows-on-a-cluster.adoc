...
[id="deploy-workflows-on-a-cluster_{context}"]
...
** OpenShift Serverless Logic {rhoserverless-logic-version}
+
...
----
. Restart the workflow Pod for Secret changes to take effect in OpenShift Serverless Logic {rhoserverless-logic-version}.
