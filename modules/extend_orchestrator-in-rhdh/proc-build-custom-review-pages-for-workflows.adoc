...
[role="_abstract"]
To build a custom review page that displays workflow data in your preferred layout, shows warnings or other messaging you implement, or integrates with your design system, implement the `getReviewComponent()` method in your form API.
