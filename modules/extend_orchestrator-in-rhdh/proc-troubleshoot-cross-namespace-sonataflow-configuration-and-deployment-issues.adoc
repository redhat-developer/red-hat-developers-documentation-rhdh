...
[id="troubleshoot-cross-namespace-sonataflow-configuration-and-deployment-issues_{context}"]
= Troubleshoot cross-namespace SonataFlow configuration and deployment issues
...
spec:
  platformRef:
    ...
    namespace: ${product-very-short}_NAMESPACE
----
    ...
    - from:
      - namespaceSelector:
          matchLabels:
            ...
            kubernetes.io/metadata.name: ${product-very-short}_NAMESPACE
      - namespaceSelector:
          matchLabels:
