...
[id="create-a-serverless-workflow-project_{context}"]
...
+
--
image::extend_orchestrator-in-rhdh/product-catalog.png["Product catalog"]
--
...
+
--
image::extend_orchestrator-in-rhdh/basic-workflow-bootstrap.png["Basic workflow bootstrap template form"]
--
