...
|`schema`
|`JSONSchema7`
|The JSON Schema definition for the workflow form. Defines field structure, titles, and UI hints such as hidden fields.

|`data`
|`JsonObject`
|The form data submitted by the user, awaiting review before the workflow runs. Contains form values structured according to the schema.
...
|Processes form data for display. Respects `ui:hidden` fields, masking password fields, and structures nested data. Use this to prepare data for rendering in your custom review component.
