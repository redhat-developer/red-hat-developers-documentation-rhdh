...
+
image::extend_orchestrator-in-rhdh/enable-the-loki-backend-module.png[]
...
----
+
image::extend_orchestrator-in-rhdh/add-loki-backend-module-plugin.png[]
...
+
image::extend_orchestrator-in-rhdh/add-loki-workflow-log-provider.png[]
+
image::extend_orchestrator-in-rhdh/loki-workflow-log-provider.png[]
+
[NOTE]
====
