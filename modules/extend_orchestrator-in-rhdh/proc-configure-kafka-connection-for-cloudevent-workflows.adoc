...
[role="_abstract"]
Configure Apache Kafka connectivity in the Orchestrator backend plugin to enable event-driven workflow execution by using CloudEvents and the "Run as Event" button in the {product-very-short} UI.
