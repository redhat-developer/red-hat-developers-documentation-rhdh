...
[id="cloudevent-structure-reference-for-workflow-design-and-troubleshooting_{context}"]
= CloudEvent structure reference for workflow design and troubleshooting
