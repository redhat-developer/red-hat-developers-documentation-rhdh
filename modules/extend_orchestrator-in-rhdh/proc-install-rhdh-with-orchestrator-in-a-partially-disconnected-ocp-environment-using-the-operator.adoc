...
[id="install-rhdh-with-orchestrator-in-a-partially-disconnected-ocp-environment-using-the-operator_{context}"]
= Install {product} with Orchestrator in a partially disconnected {ocp-short} environment using the Operator
