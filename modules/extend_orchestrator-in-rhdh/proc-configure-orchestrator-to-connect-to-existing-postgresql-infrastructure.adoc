...
* You have {configuring-book-link}#configure-external-postgresql-databases_configuring-rhdh[configured an external PostgreSQL database] that is available and accessible from your {ocp-short} cluster, including a Kubernetes Service and Secret for the database connection.
