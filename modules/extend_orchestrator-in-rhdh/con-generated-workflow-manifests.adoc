...
[id="generated-workflow-manifests_{context}"]
...
[IMPORTANT]
====
In OpenShift Serverless Logic {rhoserverless-logic-version}, after updating a secret, you must manually restart the workflow Pod for changes to apply.
====
