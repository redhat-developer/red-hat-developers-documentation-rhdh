...
* *Pin the Sidebar*: If you switch frequently between tools, go to *Settings* and enable *Pin Sidebar* to keep the navigation menu permanently visible.
...
* *Review production documentation*: Use the *Docs* menu to find production-specific documentation, such as runbooks or deployment guides linked to your components.
