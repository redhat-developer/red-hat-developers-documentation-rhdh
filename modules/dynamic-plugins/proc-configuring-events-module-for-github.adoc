...
For GitHub Organizational Data, you have enabled {product-docs-link}/html-single/authentication_in_red_hat_developer_hub/index#enabling-user-authentication-with-github [Github Authentication with user ingestion].
.Procedure
