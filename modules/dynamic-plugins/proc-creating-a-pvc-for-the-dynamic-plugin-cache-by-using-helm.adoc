...
[NOTE]
====
When you configure the Helm chart to use the PVC,
you must also include the `extraVolumes` section defined in the {default-helm-chart-values-link}[default Helm chart values].
====
