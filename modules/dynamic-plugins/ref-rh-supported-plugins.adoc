...
|GitHub  |`https://npmjs.com/package/@backstage/plugin-catalog-backend-module-github/v/0.7.8[@backstage/plugin-catalog-backend-module-github]` |0.7.8 
|`./dynamic-plugins/dist/backstage-plugin-catalog-backend-module-github-dynamic`

`GITHUB_ORG`


|GitHub Org  |`https://npmjs.com/package/@backstage/plugin-catalog-backend-module-github-org/v/0.3.5[@backstage/plugin-catalog-backend-module-github-org]` |0.3.5 
...
|RBAC  |`https://npmjs.com/package/@backstage-community/plugin-rbac/v/1.33.5[@backstage-community/plugin-rbac]` |1.33.5 
