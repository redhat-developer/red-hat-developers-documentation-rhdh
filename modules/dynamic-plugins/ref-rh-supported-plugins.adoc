...
{company-name} and its partners support the following 17 plugins:
...
|Keycloak  |`https://npmjs.com/package/@janus-idp/backstage-plugin-keycloak-backend/v/1.13.2[@janus-idp/backstage-plugin-keycloak-backend]` |1.13.2 
...
|OCM  |`https://npmjs.com/package/@janus-idp/backstage-plugin-ocm-backend/v/4.4.1[@janus-idp/backstage-plugin-ocm-backend]` |4.4.1 
...
|Quay  |`https://npmjs.com/package/@janus-idp/backstage-plugin-quay/v/1.11.7[@janus-idp/backstage-plugin-quay]` |1.11.7 
...
|RBAC  |`https://npmjs.com/package/@janus-idp/backstage-plugin-rbac/v/1.29.5[@janus-idp/backstage-plugin-rbac]` |1.29.5 
...
|Tekton  |`https://npmjs.com/package/@janus-idp/backstage-plugin-tekton/v/3.12.7[@janus-idp/backstage-plugin-tekton]` |3.12.7 
|`./dynamic-plugins/dist/janus-idp-backstage-plugin-tekton`


|Topology  |`https://npmjs.com/package/@janus-idp/backstage-plugin-topology/v/1.27.5[@janus-idp/backstage-plugin-topology]` |1.27.5 
