...
|Orchestrator Form Widgets |`https://npmjs.com/package/@redhat/backstage-plugin-orchestrator-form-widgets/v/1.8.12[@redhat/backstage-plugin-orchestrator-form-widgets]` |1.8.12 
|`@redhat/backstage-plugin-orchestrator-form-widgets@1.8.12`


|Orchestrator |`https://npmjs.com/package/@redhat/backstage-plugin-orchestrator/v/1.8.12[@redhat/backstage-plugin-orchestrator]` |1.8.12 
|`@redhat/backstage-plugin-orchestrator@1.8.12`


|Orchestrator |`https://npmjs.com/package/@redhat/backstage-plugin-orchestrator-backend/v/1.8.12[@redhat/backstage-plugin-orchestrator-backend]` |1.8.12 
|`@redhat/backstage-plugin-orchestrator-backend-dynamic@1.8.12`


|Orchestrator |`https://npmjs.com/package/@redhat/backstage-plugin-scaffolder-backend-module-orchestrator/v/1.8.12[@redhat/backstage-plugin-scaffolder-backend-module-orchestrator]` |1.8.12 
|`@redhat/backstage-plugin-scaffolder-backend-module-orchestrator-dynamic@1.8.12`
