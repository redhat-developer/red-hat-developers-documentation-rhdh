...
.Prerequisites
* You have access to the link:https://raw.githubusercontent.com/redhat-developer/rhdh/refs/heads/release-1.9/dynamic-plugins.default.yaml[`dynamic-plugins.default.yaml`] file, which lists all preloaded plugins and their default configuration.
...
. Copy the package configuration from the link:https://raw.githubusercontent.com/redhat-developer/rhdh/refs/heads/release-1.9/dynamic-plugins.default.yaml[`dynamic-plugins.default.yaml`] file.
