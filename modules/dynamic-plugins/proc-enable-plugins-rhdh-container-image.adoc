...
. Identify the {dynamic-plugins-reference-book-url}#red-hat-supported-plugins[Red Hat supported plugins] that are disabled by default.
...
+
The location of the plugin configuration file varies based on the deployment method. For more details, see {installing-and-viewing-plugins-book-url}[{installing-and-viewing-plugins-book-title}].
...
----
For more information about how to configure dynamic plugins in {product-short}, see {configuring-dynamic-plugins-book-url}[{configuring-dynamic-plugins-book-title}].
--
