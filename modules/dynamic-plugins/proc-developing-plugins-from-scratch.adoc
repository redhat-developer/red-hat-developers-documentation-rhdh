...
.Verification
Navigate to `http://localhost:3000/simple-example/entity` in your browser. Confirm that the *Entity Page* appears with your `ExampleCard` component displaying "Entity: example-service".
