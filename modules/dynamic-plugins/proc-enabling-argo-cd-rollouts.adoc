<<<<<<< HEAD
<<<<<<< HEAD:modules/dynamic-plugins/proc-enabling-argo-cd-rollouts.adoc
:_mod-docs-content-type: PROCEDURE
[id="enabling-argo-cd-rollouts_{context}"]
= Enabling Argo CD Rollouts
=======
=======
<<<<<<< HEAD:artifacts/rhdh-plugins-reference/argocd/argocd-plugin-admin.adoc
>>>>>>> c7d441f93 (RHIDP-7472 - Modularize plugins content in artifacts/rhdh-plugins-reference)
...
== Enabling Argo CD Rollouts
<<<<<<< HEAD
>>>>>>> f22ef29fc (Added note for bug (#1351)):artifacts/rhdh-plugins-reference/argocd/argocd-plugin-admin.adoc
=======
=======
:_mod-docs-content-type: PROCEDURE
[id="enabling-argo-cd-rollouts_{context}"]
= Enabling Argo CD Rollouts
>>>>>>> 975f3073e (RHIDP-7472 - Modularize plugins content in artifacts/rhdh-plugins-reference):modules/dynamic-plugins/proc-enabling-argo-cd-rollouts.adoc
>>>>>>> c7d441f93 (RHIDP-7472 - Modularize plugins content in artifacts/rhdh-plugins-reference)
