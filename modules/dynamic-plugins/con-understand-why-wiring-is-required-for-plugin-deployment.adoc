...
Front-end components need instructions on where to be registered in the application UI. The application does not automatically know where the UI components of a plugin must appear.
