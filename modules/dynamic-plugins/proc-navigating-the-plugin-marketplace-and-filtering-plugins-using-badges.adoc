...
* To find *Certified* plugins, apply the `Certified` filter. For these plugins, helper text is available both on the main plugin list page and on the individual plugin details page to explain what certification entails.
