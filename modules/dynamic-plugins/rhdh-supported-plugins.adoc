...
|parfuemerie-douglas-scaffolder-backend-module-azure-repositories-dynamic |Backend |@parfuemerie-douglas/scaffolder-backend-module-azure-repositories-dynamic |A collection of Microsoft Azure pipeline actions for the scaffolder backend |0.2.7 |Community Support |./dynamic-plugins/dist/parfuemerie-douglas-scaffolder-backend-module-azure-repositories-dynamic | |Disabled
...
|HTTP Request |Backend |@roadiehq/scaffolder-backend-module-http-request
|Backstage plugin to call any of the Backstage APIs available to the user. |4.1.10 |Community Support
