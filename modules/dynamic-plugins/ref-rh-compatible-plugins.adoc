...
* The above Red Hat Ansible Automation Platform (RHAAP) plugins, can be used as a replacement for the older plugin listed in the link:{configuring-dynamic-plugins-url}#rhdh-tech-preview-plugins[Technology Preview plugins] section of the _{configuring-dynamic-plugins-book-title} guide_.
====
