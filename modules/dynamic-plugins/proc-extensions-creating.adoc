...
// |`oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/backstage-community-plugin-3scale-backend:__<tag>__`, where `<tag>` is the version tag corresponding to the {product-short} version. For the latest tags, see the link:https://github.com/redhat-developer/rhdh-plugin-export-overlays[rhdh-plugin-export-overlays repository]
