...
A key feature of {product-very-short} is the ability to import your own custom built or third-party plugins or to create new features using dynamic plugins.
