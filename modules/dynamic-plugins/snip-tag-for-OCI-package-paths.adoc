...
.. Locate the plugin version for paths starting with `oci://ghcr.io` in one of the tables provided in the {dynamic-plugins-reference-book-link}[Dynamic Plugins Reference guide].
+
