...
Because dynamic front-end plugins load their code at runtime, the {product-short} application requires explicit instructions to integrate the components of a plugin must appear in the user interface (UI).
