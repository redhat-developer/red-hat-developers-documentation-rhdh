...
The following plugins were previously bundled as wrappers in {product-short} 1.8 and will continue to be bundled in 1.9 while transitioning to ghcr.io distribution in a future release:
...
. To avoid unexpected updates, consider using a SHA256 digest instead of a tag
