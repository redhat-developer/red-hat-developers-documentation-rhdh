...
// * xref:install-dynamic-plugins-with-the-rhdh-operator_rhdh-installing-rhdh-plugins[Installing dynamic plugins with the {product} Operator]
// * xref:installing-dynamic-plugins-using-the-helm-chart_rhdh-installing-rhdh-plugins[Installing dynamic plugins using the Helm chart]
