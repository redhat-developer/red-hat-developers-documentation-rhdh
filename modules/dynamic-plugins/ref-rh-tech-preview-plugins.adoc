...
|Bulk Import  |`https://npmjs.com/package/@red-hat-developer-hub/backstage-plugin-bulk-import/v/1.13.3[@red-hat-developer-hub/backstage-plugin-bulk-import]` |1.13.3 
|`./dynamic-plugins/dist/red-hat-developer-hub-backstage-plugin-bulk-import`


|Bulk Import  |`https://npmjs.com/package/@red-hat-developer-hub/backstage-plugin-bulk-import-backend/v/6.1.3[@red-hat-developer-hub/backstage-plugin-bulk-import-backend]` |6.1.3 
...
|GitLab  |`https://npmjs.com/package/@immobiliarelabs/backstage-plugin-gitlab/v/6.12.0[@immobiliarelabs/backstage-plugin-gitlab]` |6.12.0 
...
|Http Request  |`https://npmjs.com/package/@roadiehq/scaffolder-backend-module-http-request/v/5.3.3[@roadiehq/scaffolder-backend-module-http-request]` |5.3.3 
...
|Marketplace  |`https://npmjs.com/package/@red-hat-developer-hub/backstage-plugin-marketplace/v/0.7.0[@red-hat-developer-hub/backstage-plugin-marketplace]` |0.7.0 
|`./dynamic-plugins/dist/red-hat-developer-hub-backstage-plugin-marketplace`


|Marketplace  |`https://npmjs.com/package/@red-hat-developer-hub/backstage-plugin-catalog-backend-module-marketplace/v/0.3.3[@red-hat-developer-hub/backstage-plugin-catalog-backend-module-marketplace]` |0.3.3 
|`./dynamic-plugins/dist/red-hat-developer-hub-backstage-plugin-catalog-backend-module-marketplace-dynamic`


|Marketplace  |`https://npmjs.com/package/@red-hat-developer-hub/backstage-plugin-marketplace-backend/v/0.6.0[@red-hat-developer-hub/backstage-plugin-marketplace-backend]` |0.6.0 
...
|Tech Radar  |`https://npmjs.com/package/@backstage-community/plugin-tech-radar/v/1.7.0[@backstage-community/plugin-tech-radar]` |1.7.0 
