...
* The {plugin-type-name} plugin is compatible with your {product} version. For more information, see link:https://github.com/redhat-developer/rhdh/blob/release-{product-version}/docs/dynamic-plugins/versions.md[Version compatibility matrix].
