...
{product-short} includes the following 42 community plugins:
...
|Bulk Import  |`https://npmjs.com/package/@janus-idp/backstage-plugin-bulk-import-backend/v/1.5.3[@janus-idp/backstage-plugin-bulk-import-backend]` |1.5.3 
