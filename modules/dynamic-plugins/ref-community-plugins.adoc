...
|Bulk Import  |`https://npmjs.com/package/@janus-idp/backstage-plugin-bulk-import-backend/v/1.4.1[@janus-idp/backstage-plugin-bulk-import-backend]` |1.4.1 
...
|Pingidentity  |`https://npmjs.com/package/@backstage/community-plugin-catalog-backend-module-pingidentity/v/0.1.1[@backstage/community-plugin-catalog-backend-module-pingidentity]` |0.1.1 
