...
|Argo CD (Red Hat)  |`https://npmjs.com/package/@backstage-community/plugin-redhat-argocd/v/1.8.10[@backstage-community/plugin-redhat-argocd]` |1.8.10 
...
|Bulk Import  |`https://npmjs.com/package/@janus-idp/backstage-plugin-bulk-import-backend/v/1.5.5[@janus-idp/backstage-plugin-bulk-import-backend]` |1.5.5 
