...
|Bulk Import  |`https://npmjs.com/package/@red/hat-developer-hub-backstage-plugin-bulk-import/v/1.8.0[@red/hat-developer-hub-backstage-plugin-bulk-import]` |1.8.0 
|`./dynamic-plugins/dist/red-hat-developer-hub-backstage-plugin-bulk-import`


|Bulk Import  |`https://npmjs.com/package/@red/hat-developer-hub-backstage-plugin-bulk-import-backend/v/5.1.0[@red/hat-developer-hub-backstage-plugin-bulk-import-backend]` |5.1.0 
...
|Notifications  |`https://npmjs.com/package/@backstage/plugin-notifications-backend/v/0.4.1[@backstage/plugin-notifications-backend]` |0.4.1 
|`./dynamic-plugins/dist/backstage-plugin-notifications-backend-dynamic`


|Notifications Module Email  |`https://npmjs.com/package/@backstage/plugin-notifications-backend-module-email/v/0.3.1[@backstage/plugin-notifications-backend-module-email]` |0.3.1 
...
|Topology  |`https://npmjs.com/package/@backstage-community/plugin-topology/v/1.29.6[@backstage-community/plugin-topology]` |1.29.6 
