...
= Configuring RBAC for Scorecards
 ...
 * You have added `scorecard` to the list of authorized plugins under `permission.rbac.pluginsWithPermission` in your configuration.
