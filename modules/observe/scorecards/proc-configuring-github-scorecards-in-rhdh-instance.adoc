...
... Create a https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#creating-a-fine-grained-personal-access-token[GitHub token] to all {product-very-short} access to the GitHub API. You can create the token with any of the following permissions:
