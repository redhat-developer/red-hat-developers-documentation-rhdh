...
... Create and configure the GitHub App to allow {product-very-short} access to the GitHub API:
+
[NOTE]
====
...
... Create a GitHub token with the necessary scope (Example: `repo` for read/write access to private repositories) to allow {product-very-short} access to the GitHub API.
