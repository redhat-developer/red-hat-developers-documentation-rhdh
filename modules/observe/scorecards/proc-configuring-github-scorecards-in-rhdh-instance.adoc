...
To enable the GitHub metrics integration, you must create and configure a GitHub App to grant {product-very-short} access to the GitHub API using either a https://docs.github.com/en/apps/overview[GitHub App] or a https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens[GitHub token].
+
[IMPORTANT]
====
...
. To allow {product-very-short} to access the GitHub API, create and configure a GitHub App or generating a GitHub token, and add the necessary integration to your configuration file:
+
[NOTE]
====
You must install the GitHub App on the organization (or user account) that owns repositories, granting it the necessary repository access permissions.
====
