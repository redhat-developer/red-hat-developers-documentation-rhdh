...
You can configure the Scorecard plugin to aggregate results for parent entities by updating your {product-very-short} configuration. To assess portfolio health, you must define which groups are included in the aggregation and how often the data is updated.
