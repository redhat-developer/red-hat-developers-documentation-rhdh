...
The aggregation endpoint (`/metrics/:metricId/catalog/aggregations`) summarizes metrics based on entity ownership. By default, the plug-in only considers direct ownership, which includes the following entities:
