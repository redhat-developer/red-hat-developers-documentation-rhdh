...
spec:
  type: team
  children: [user:default/userName]
----
...
To include a component in a user's or team's aggregated metrics, you must define the owner in the `Component` specification.
