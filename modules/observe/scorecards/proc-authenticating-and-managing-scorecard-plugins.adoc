...
.Prerequisite
 * You have {authorization-book-link}#enabling-and-giving-access-to-rbac[enabled RBAC, have a policy administrator role in {product-very-short}, and have added the Scorecard to plugins with permission].
