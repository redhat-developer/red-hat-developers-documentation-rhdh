...
[id="enable-metrics-monitoring-in-a-red-hat-developer-hub-operator-installation-on-an-openshift-container-platform-cluster_{context}"]
...
. Use the *OpenShift CLI* (`oc`) to edit your existing {product} CR. Backstage
+
[source,terminal,subs="+attributes"]
----
$ oc edit {product-custom-resource-type} <instance-name>
----
