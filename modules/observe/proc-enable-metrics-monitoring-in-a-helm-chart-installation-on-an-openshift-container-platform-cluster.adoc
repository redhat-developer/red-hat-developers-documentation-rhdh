...
[id="enable-metrics-monitoring-in-a-helm-chart-installation-on-an-openshift-container-platform-cluster_{context}"]
...
+
image::rhdh/helm-upgrade.png["Helm chart overflow menu showing the Upgrade option"]
...
----
+
image::rhdh/upgrade-helm-metrics.png["YAML view showing the metrics configuration section"]
