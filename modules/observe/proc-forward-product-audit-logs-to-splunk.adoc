...
+
`AtLeastOnce`::
The `AtLeastOnce` delivery mode ensures that if the log forwarder crashes or restarts, any logs read but not yet delivered are re-sent to their destination.
