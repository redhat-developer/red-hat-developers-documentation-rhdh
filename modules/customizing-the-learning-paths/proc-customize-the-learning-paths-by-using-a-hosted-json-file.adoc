...
[id="customize-the-learning-paths-by-using-a-hosted-json-file_{context}"]
= Customize the Learning Paths by using a hosted JSON file
...
* xref:customize-the-home-page_customize-the-home-page[Customize the Home page]
