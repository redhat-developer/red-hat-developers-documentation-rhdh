...
You can use Microsoft Azure as an authentication provider in {product}, when installed using the Helm Chart. For more information, see xref:proc-rhdh-deploy-aks-using-helm_{context}[].
