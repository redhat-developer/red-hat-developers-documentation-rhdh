[id="proc-configuring-postgresql-secrets-in-RHDH_{context}"]
= Configuring PostgreSQL secrets in RHDH

You can configure PostgreSQL credential and certificate secrets in the {product} application. This configuration helps you to connect {product-short} with the PostgreSQL database.
...
.. Add PostgreSQL credential and certificate secrets in the `<rhdh-custom-resource>` file:
+
[source,yaml]
----
# ...
