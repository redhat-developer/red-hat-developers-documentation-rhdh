...
. Reconfigure your `Backstage` custom resource (CR). For more information, see link:{LinkAdminGuide}#proc-configuring-postgresql-instance-using-operator_{context}[Configuring an external PostgreSQL instance using the Operator].
