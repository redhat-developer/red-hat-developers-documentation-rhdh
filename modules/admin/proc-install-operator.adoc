...
//* For more information about installing {product-short}, see xref:proc-install-rhdh-ocp-operator_{context}[Deploying {product} on {ocp-short} using the Operator].
