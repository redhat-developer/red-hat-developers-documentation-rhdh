...
For Azure database, you can generate a PostgreSQL certificate file in the .pem format. The content of this certificate file is used for creating a certificate secret to configure a PostgreSQL instance in {product-short}.
