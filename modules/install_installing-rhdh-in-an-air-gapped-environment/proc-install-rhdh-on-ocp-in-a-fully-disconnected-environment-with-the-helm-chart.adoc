...
** You have installed GNU `tar` 1.35 or later, `jq` 1.7 or later, the {openshift-cli}, the {ocp-docs-link}/html-single/disconnected_environments/index#installation-oc-mirror-installing-plugin_about-installing-oc-mirror-v2[`oc-mirror`] OpenShift CLI plugin *v2*, and Skopeo 1.20 or later on your workstation.
