...
* You have installed Skopeo 1.20 or later, GNU `tar` 1.35 or later, and `jq` 1.7 or later.
* You have installed `yq` 4.44 or later and the GNU `sed` command line text editor.
