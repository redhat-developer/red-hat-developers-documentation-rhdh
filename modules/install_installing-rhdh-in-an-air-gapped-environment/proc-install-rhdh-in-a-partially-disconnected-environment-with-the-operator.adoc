...
.Prerequisites
* You have installed Podman 5.3 or later, Skopeo 1.20 or later, `yq` 4.44 or later, GNU `tar` 1.35 or later, GNU `sed`, `jq` 1.7 or later, and the `umoci` CLI tool. For more information about installing Podman, see link:https://podman.io/docs/installation[Podman Installation Instructions].
