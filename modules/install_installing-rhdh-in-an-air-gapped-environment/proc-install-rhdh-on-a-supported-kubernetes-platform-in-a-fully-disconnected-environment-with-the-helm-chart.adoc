...
----
{product-very-short}_IMAGE=$(yq '.upstream.backstage.image | .registry + "/" + .repository' values.default.yaml)
{product-very-short}_DIGEST=$(yq '.upstream.backstage.image.tag' values.default.yaml)
