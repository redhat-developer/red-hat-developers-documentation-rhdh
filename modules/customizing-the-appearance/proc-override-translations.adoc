...
[id="proc-override-translations_{context}"]
...
* xref:proc-enable-localization-in-quickstarts_customizing-the-quickstarts[Enable quick start localization in {product-short}]
