...
[id="configure-model-context-protocol-in-red-hat-developer-hub_{context}"]
...
* You have {model-context-protocol-link}#install-the-mcp-server-and-tool-plugins-in-red-hat-developer-hub[installed the MCP server and tool plugins in {product}].
