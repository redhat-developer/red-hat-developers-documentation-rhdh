...
.. If you are unsure, see {model-context-protocol-link}#configure-model-context-protocol-in-red-hat-developer-hub[the sample app configuration provided in the reference procedure].