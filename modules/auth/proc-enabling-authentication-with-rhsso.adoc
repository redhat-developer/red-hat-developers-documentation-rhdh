...
.. Save your **RHSSO realm base URL** for the next step, such as: __<your_rhsso_URL>__/auth/realms/__<my_realm>__.
...
`AUTH_OIDC_METADATA_URL`:: Enter your **RHSSO realm base URL**, such as: __<your_rhsso_URL>__/auth/realms/__<my_realm>__.
