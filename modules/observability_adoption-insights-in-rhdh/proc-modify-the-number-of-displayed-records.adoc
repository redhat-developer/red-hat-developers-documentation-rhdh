...
[id="modify-the-number-of-displayed-records_{context}"]
= Modify the number of displayed records
...
+
image::observability_adoption-insights-in-rhdh/adoption-insights-catalog-entities.jpg[Catalog Entities dropdown]
