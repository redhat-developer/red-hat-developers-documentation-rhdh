...
Enable this option
to add transitive parent groups into the resolved user group membership during the authentication process, therefore to include the parent group of the user's direct group in the user ownership entities.
