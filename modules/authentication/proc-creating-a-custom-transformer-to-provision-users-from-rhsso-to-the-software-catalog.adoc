...
To customize how Keycloak users/groups are mapped into {product} entities, you can create a backend module that utilizes the `keycloakTransformerExtensionPoint` to provide custom user and group transformers to the Keycloak backend.
