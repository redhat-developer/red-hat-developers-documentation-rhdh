...
To customize how {product} provision users and groups to {product} software catalog entities,
you can create a backend module that uses the `keycloakTransformerExtensionPoint` to offer custom user and group transformers for the Keycloak backend.
