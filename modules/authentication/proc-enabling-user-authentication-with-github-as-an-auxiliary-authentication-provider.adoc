...
Skips user identity resolution for this provider to enable sign-in from an auxiliary authentication provider. Do not enable this setting on the primary auth provider you plan on using for sign-in and identity management.
