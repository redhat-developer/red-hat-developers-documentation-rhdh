...
. To add your GitHub credentials to {product-short}, add the following key/value pairs to link:{configuring-dynamic-plugins-url}#provisioning-your-custom-configuration[your {product-short} secrets]:
+
