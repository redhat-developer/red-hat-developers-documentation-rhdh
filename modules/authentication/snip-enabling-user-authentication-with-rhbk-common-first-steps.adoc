...
. Create a long, complex, and unique string to be used as the {product-short} session secret key.

. Add your {rhbk} credentials and session secret key to {product-short}, by adding the following key/value pairs to {configuring-dynamic-plugins-book-link}#provisioning-your-custom-configuration[your {product-short} secrets].
