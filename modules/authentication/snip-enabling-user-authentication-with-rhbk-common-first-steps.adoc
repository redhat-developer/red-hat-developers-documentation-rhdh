...
* You have link:{rhbk-docs-links}/html-single/getting_started_guide/index#getting-started-zip-log-in-to-the-admin-console[access to {rhbk}] with an {rhbk-docs-link}/html-single/getting_started_guide/index#getting-started-zip-create-an-admin-user[admin user].
+
[TIP]
====
...
. Add your {rhbk} credentials to {product-short}, by
