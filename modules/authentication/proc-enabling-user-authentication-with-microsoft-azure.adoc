...
.. On the *Applications > App registrations > __{my-product-app-name-in-azure}__ > Manage > API permissions* page, *Add a Permission*, select the *Microsoft Graph* API, and select the following *Application permission*:
