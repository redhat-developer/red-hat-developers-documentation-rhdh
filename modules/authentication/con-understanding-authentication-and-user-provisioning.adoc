...
Understanding this process is essential for successfully {configuring-book-link}[configuring your {product-short} instance], link:{authorization-book-link}[securing access through authorization], and enabling features that rely on synchronized user and group data.
