...
[id="proc_setting-access-restrictions-to-external-service-tokens"]
= Setting access restrictions to external service tokens
...
To control what an external service can do, define access restrictions.
