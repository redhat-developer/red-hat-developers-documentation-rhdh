...
[id="proc-fix-predefined-arrays-overwritten_{context}"]
= Fix Helm overwriting predefined arrays

[role="_abstract"]
If you use Helm to install dynamic plugins,
you might encounter an issue where predefined values in fields with arrays are overwritten after you add new values.
