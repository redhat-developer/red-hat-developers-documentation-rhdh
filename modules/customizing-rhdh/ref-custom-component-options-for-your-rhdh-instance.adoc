...
[id="custom-component-options-for-your-rhdh-instance_{context}"]
= Custom component options for your {product-short} instance

[role="_abstract"]
You can use two component variants (Patternfly or MUI) to customize various components of your {product-short} theme.
