...
[id="deploy-on-aks-with-the-helm-chart_{context}"]
...
* You have installed the https://learn.microsoft.com/en-us/cli/azure/install-azure-cli?view=azure-cli-latest[Azure CLI].
