...
Files with a _.k8s_ extension provide overrides for vanilla Kubernetes environments, and files with a _.ocp_ extension (for example, _app-config.yaml.ocp_) provide overrides for OpenShift environments.
