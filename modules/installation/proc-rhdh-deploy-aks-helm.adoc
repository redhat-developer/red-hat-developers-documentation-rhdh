...
* link:https://learn.microsoft.com/en-us/cli/azure/install-azure-cli[Installing Azure CLI]
* link:https://kubernetes.io/docs/reference/kubectl/[Installing kubectl CLI]