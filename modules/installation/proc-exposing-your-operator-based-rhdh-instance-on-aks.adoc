            ...
            backend:
              service:
                ...
                port:
                  name: http-backend
----
. You must update your required domain name to point to the provisioned IP address. {eks-name} provisions an Application Load Balancer (ALB) with a corresponding IP address.
