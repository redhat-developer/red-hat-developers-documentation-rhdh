...
. Access the deployed {product-short} using the URL: `pass:[https://<app_address>]`, where _<app_address>_ is the Ingress address obtained earlier (for example, `https://108.141.70.228`).
