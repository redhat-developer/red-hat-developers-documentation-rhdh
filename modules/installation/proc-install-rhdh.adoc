...
* link:{LinkAdminGuide}#proc-configuring-postgresql-instance-using-operator_{context}[Configuring an external PostgreSQL instance using the Operator] 
* link:{LinkAdminGuide}#proc-configuring-postgresql-instance-using-helm_{context}[Configuring an external PostgreSQL instance using the Helm Chart]
====