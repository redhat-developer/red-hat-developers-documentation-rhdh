...
The {rhec}, based on the Operator Lifecycle Manager (OLM) framework,
...
* The Operator Lifecycle Manager (OLM) framework and the {rhec} are not built-in.
* The {rhec} pull-secret is not managed globally.

Therefore, install the OLM framework, the {rhec},
and provision your {rhec} pull secret to install {product-short} Operator.
