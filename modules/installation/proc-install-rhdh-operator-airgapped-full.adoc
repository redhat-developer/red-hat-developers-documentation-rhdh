...
* You have an active `oc registry`, `podman`, or `skopeo` session to the {rhcr-long}. For more information, see link:https://access.redhat.com/articles/RegistryAuthentication[{company-name} Container Registry Authentication].
