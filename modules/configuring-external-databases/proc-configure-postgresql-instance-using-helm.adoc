...
[id="configure-postgresql-instance-using-helm_{context}"]
= Configure an external PostgreSQL instance using the Helm Chart

[role="_abstract"]
Configure an external PostgreSQL instance using the Helm Chart instead of the default local PostgreSQL instance.
