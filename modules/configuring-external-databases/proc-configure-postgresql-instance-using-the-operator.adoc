...
[id="configure-postgresql-instance-using-operator_{context}"]
= Configure an external PostgreSQL instance using the Operator

[role="_abstract"]
Configure an external PostgreSQL instance using the {product} Operator instead of the default local PostgreSQL instance.
