...
[role="_abstract"]
When planning your {product} deployment, you must choose between the Helm chart and Operator installation methods. Use the following guidance to choose the method that aligns with your operational model and team capabilities.

[cols="1,1",options="header"]
|===
|Choose Helm chart when... |Choose Operator when...
