...
[id="system-architecture-for-deployment-planning_{context}"]
...
image::discover_about-rhdh/rhdh-architecture-diagram.png["System architecture diagram for {product}"]
