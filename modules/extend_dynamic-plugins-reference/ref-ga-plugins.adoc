...
|Lightspeed |`https://npmjs.com/package/@red-hat-developer-hub/backstage-plugin-lightspeed/v/2.8.5[@red-hat-developer-hub/backstage-plugin-lightspeed]` |2.8.5 
...
|Lightspeed |`https://npmjs.com/package/@red-hat-developer-hub/backstage-plugin-lightspeed-backend/v/2.8.5[@red-hat-developer-hub/backstage-plugin-lightspeed-backend]` |2.8.5 
