...
.. Find `appConfigExamples[0].content` — this contains the configuration (frontend and/or backend) that goes under `pluginConfig:`
...
plugins:
  - package: oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/backstage-community-plugin-jenkins-backend:bs_1.45.3__0.26.0
    disabled: false
    pluginConfig:
