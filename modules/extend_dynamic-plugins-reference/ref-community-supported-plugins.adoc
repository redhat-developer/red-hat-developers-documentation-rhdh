...
[role="_abstract"]
{company-name} provides community support for the following 60 dynamic plugins in `ghcr.io`.
...
|*APIC*
|1.0.3
|`oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/apic-backstage:<tag>`
...
|*DQL Backend*
|2.7.0
|`oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/dynatrace-backstage-plugin-dql-backend:<tag>`
...
|*DQL Frontend*
|2.7.0
|`oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/dynatrace-backstage-plugin-dql:<tag>`
