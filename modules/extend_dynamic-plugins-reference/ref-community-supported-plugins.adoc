...
[role="_abstract"]
{company-name} provides community support for the following 38 dynamic plugins in `ghcr.io`.
...
|1.23.1|`oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/backstage-community-plugin-nexus-repository-manager:<tag>`
