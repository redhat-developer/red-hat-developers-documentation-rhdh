...
|Orchestrator |`https://npmjs.com/package/@red-hat-developer-hub/backstage-plugin-orchestrator/v/5.7.6[@red-hat-developer-hub/backstage-plugin-orchestrator]` |5.7.6 
...
|RBAC |`https://npmjs.com/package/@backstage-community/plugin-rbac/v/1.52.2[@backstage-community/plugin-rbac]` |1.52.2 
