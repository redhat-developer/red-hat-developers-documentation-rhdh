...
[id="deploy-rhdh-on-ocp-with-the-operator_{context}"]
= Deploy {product} on {ocp-short} with the Operator
...
* xref:install-the-rhdh-operator_{context}[An {ocp-short} administrator has installed the {product} Operator].
...
. On the *Create {product-custom-resource-type}* page, click *Create*.
...
+
image::install_installing-rhdh-on-ocp/operator-install-1.png["Operator installation topology view in the OpenShift web console"]

[role="_additional-resources"]
[id="additional-resources_deploy-on-with-the-operator"]
