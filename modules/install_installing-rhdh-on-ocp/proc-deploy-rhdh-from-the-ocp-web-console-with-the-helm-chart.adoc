...
* You have logged in to your {ocp-short} account.
...
+
image::install_installing-rhdh-on-ocp/rhdh-helm-install.png["Helm chart installation in the OpenShift web console"]
+
[NOTE]
====
The host information is copied and can be accessed by the {product-short} backend.
