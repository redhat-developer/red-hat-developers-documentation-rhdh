...
[id='deploy-product-short-from-the-ocp-short-web-console-with-the-helm-chart_{context}']
...
** Using *Form view*
+
.. To configure the instance with the Form view, go to *Root Schema* -> *global* -> *Enable service authentication within {product} instance* and paste your {ocp-short} router host into the field on the form.
...
+
image::install_installing-rhdh-on-ocp/rhdh-helm-install.png[]
+
[NOTE]
====
