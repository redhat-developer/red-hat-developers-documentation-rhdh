...
data:
  dynamic-plugins.yaml: |
    ...
    plugins:
      - package: oci://registry.redhat.io/rhdh/backstage-plugin-kubernetes-backend:1.10
        disabled: false
...
[NOTE]
====
The `backstage-plugin-kubernetes` plugin is currently in link:https://access.redhat.com/support/offerings/techpreview[{technology-preview}]. As an alternative, you can use the `oci://registry.redhat.io/rhdh/backstage-plugin-topology` plugin, which is Generally Available (GA).
====
