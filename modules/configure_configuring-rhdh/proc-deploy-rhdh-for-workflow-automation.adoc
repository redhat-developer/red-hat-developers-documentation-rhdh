...
* You have installed the required infrastructure components for Orchestrator. For details about the components, see {orchestrator-book-link}#understand-orchestrator-architecture_orchestrator-rhdh[Understand Orchestrator architecture].
