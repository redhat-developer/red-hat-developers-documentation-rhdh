...
[id="enabling-github-repository-discovery_{context}"]
= Enable GitHub repository discovery

[role="_abstract"]
Configure automatic GitHub repository discovery to import repositories containing catalog-info.yaml files into the {product-short} catalog without manual registration.
