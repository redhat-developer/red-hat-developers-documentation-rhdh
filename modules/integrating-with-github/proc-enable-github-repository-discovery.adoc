...
[role="_abstract"]
Configure automatic GitHub repository discovery to ingest repositories containing catalog-info.yaml files into the Red Hat Developer Hub catalog without manual registration.
