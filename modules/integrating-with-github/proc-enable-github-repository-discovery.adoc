...
[role="_abstract"]
Configure automatic GitHub repository discovery to ingest repositories containing catalog-info.yaml files into the {product-short} catalog without manual registration.
