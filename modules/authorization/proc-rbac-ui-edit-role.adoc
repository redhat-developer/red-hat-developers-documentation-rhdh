...
[role="_abstract"]
Edit a role in {product-short} by using the Web UI to modify role details, users, groups, and permission policies.
...
* You can also edit a role’s users and groups or permissions by using the edit icon on the respective cards on the *OVERVIEW* page.
