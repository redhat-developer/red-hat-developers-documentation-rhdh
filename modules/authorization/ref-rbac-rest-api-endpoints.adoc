...
[NOTE]
To prevent an inconsistent state after a deployment restart, the REST API does not allow you to delete plugin IDs defined in the application configuration. You must remove these IDs from the configuration file directly.
