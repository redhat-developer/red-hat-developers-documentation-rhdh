...
* The external service can send HTTP GET request, and is {authentication-book-link}#service-to-service-authentication[authenticated by using a service-to-service token].
