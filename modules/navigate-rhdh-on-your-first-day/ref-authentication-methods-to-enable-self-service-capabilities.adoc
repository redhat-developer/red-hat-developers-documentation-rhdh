...
To access the specific tools, repositories, and permissions assigned to your role, you must authenticate to {product} ({product-very-short}) using a supported provider. Selecting the correct authentication method makes sure that the portal correctly associates your identity with your team's software components and self-service capabilities.
