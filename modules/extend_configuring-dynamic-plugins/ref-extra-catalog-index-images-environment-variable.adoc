...
[id="variable-name_{context}"]
== Variable name

`EXTRA_CATALOG_INDEX_IMAGES`

[id="env-var-purpose_{context}"]
== Purpose
...
[id="subdirectory-naming-examples_{context}"]
...
[id="env-var-relationship-to-catalog-index-image_{context}"]
...
[id="env-var-duplicate-handling_{context}"]
== Duplicate handling
...
[id="supported-deployment-methods_{context}"]
