...
[role="_abstract"]
{product} can extract plugins from multiple catalog index images to populate the Extensions UI. Understanding the distinction between primary and extra catalog index images helps you control which plugins install automatically and which plugins require explicit configuration.

[id="what-catalog-index-images-contain_{context}"]
...
[id="primary-catalog-index-image_{context}"]
...
[id="extra-catalog-index-images_{context}"]
...
[id="why-this-separation-matters_{context}"]
