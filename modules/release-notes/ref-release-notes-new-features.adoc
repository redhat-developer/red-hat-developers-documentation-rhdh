...
== Added Orchestrator plugins with dependencies to the {product-very-short} profile
...
* Preserved typed input in the Search fields when selecting users, groups, or plugins.
