...
+
--
After upgrading to {product-short} 1.2, user policies are not automatically migrated or updated, resulting in items not appearing the catalog or software templates.

To resolve this issue, after upgrading to version 1.2, users need to add the necessary policies in the RBAC page.
--