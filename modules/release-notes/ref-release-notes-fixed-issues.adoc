...
=== Catalog Graph issue resolved

In {product-short} 1.8.2, the Catalog Graph failed to render when users navigated to the full-size relational graphic from an entity's *Dependencies* tab. This issue was caused by a library conflict, which is now resolved. The Catalog Graph functions as expected.
