...
To get a comprehensive list of supported dynamic plugins, see the link:{LinkPluginsGuide}#rhdh-supported-plugins[Dynamic plugins included in {product}] section in the _{NameOfPluginsGuide} guide_.

== Compatible plugins in {product} {product-version}

To get a comprehensive list of compatible dynamic plugins, see the link:{LinkPluginsGuide}#rhdh-compatible-plugins[Compatible plugins] section in the _{NameOfPluginsGuide} guide_.
