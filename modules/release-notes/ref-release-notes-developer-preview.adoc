...
[id="developer-preview-rhdhplan-697"]
...
// Link in comment to facilitate reviews: https://issues.redhat.com/browse/RHDHPLAN-697
...
== OpenShift AI Connector for {product}

You can use OpenShift AI Connector for RHDH to enable users to use {product} ({product-very-short}) to surface AI Models and Model Servers from Red Hat OpenShift AI (RHOAI) directly into the RHDH/Backstage Catalog.
...
You can enhance your {product} integration by leveraging the Model Context Protocol (MCP) server. This integration enables seamless communication with various Artificial Intelligence (AI) clients, facilitating efficient data exchange and expanding the functionality of the platform.
