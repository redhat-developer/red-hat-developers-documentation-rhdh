...
With this update, the `parfuemerie-douglas-scaffolder-backend-module-azure-repositories-dynamic` is removed from the Azure Repositories. Use `./dynamic-plugins/dist/parfuemerie-douglas-scaffolder-backend-module-azure-repositories-dynamic` instead.
