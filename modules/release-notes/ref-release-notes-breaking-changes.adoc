...
[NOTE]
====
Along with the tables provided previously, you can compare the following files to see which dynamic plugins have changed between {product-very-short} 1.3 and {product-very-short} 1.4:
